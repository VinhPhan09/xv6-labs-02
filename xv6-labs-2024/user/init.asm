...
main(void)
{
  ...
  12:	8c250513          	addi	a0,a0,-1854 # 8d0 <malloc+0xdc>
  ...
  2e:	8ae90913          	addi	s2,s2,-1874 # 8d8 <malloc+0xe4>
  32:	854a                	mv	a0,s2
  34:	706000ef          	jal	ra,73a <printf>
    pid = fork();
  ...
  56:	8d650513          	addi	a0,a0,-1834 # 928 <malloc+0x134>
  5a:	6e0000ef          	jal	ra,73a <printf>
        exit(1);
  5e:	4505                	li	a0,1
  ...
  6c:	86850513          	addi	a0,a0,-1944 # 8d0 <malloc+0xdc>
  70:	300000ef          	jal	ra,370 <mknod>
    open("console", O_RDWR);
  74:	4589                	li	a1,2
  76:	00001517          	auipc	a0,0x1
  7a:	85a50513          	addi	a0,a0,-1958 # 8d0 <malloc+0xdc>
  7e:	2ea000ef          	jal	ra,368 <open>
  82:	bf71                	j	1e <main+0x1e>
      printf("init: fork failed\n");
  84:	00001517          	auipc	a0,0x1
  88:	86c50513          	addi	a0,a0,-1940 # 8f0 <malloc+0xfc>
  8c:	6ae000ef          	jal	ra,73a <printf>
      exit(1);
  90:	4505                	li	a0,1
  ...
  a2:	86a50513          	addi	a0,a0,-1942 # 908 <malloc+0x114>
  a6:	2ba000ef          	jal	ra,360 <exec>
      printf("init: exec sh failed\n");
  aa:	00001517          	auipc	a0,0x1
  ae:	86650513          	addi	a0,a0,-1946 # 910 <malloc+0x11c>
  b2:	688000ef          	jal	ra,73a <printf>
      exit(1);
  b6:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 400:	0805c663          	bltz	a1,48c <printint+0x9e>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ...
 44e:	0028071b          	addiw	a4,a6,2
  ...
  while(--i >= 0)
 452:	02e05663          	blez	a4,47e <printint+0x90>
 ...
 472:	8526                	mv	a0,s1
 474:	f5dff0ef          	jal	ra,3d0 <putc>
  while(--i >= 0)
 478:	197d                	addi	s2,s2,-1
 47a:	ff391ae3          	bne	s2,s3,46e <printint+0x80>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b6:	22090e63          	beqz	s2,6f2 <vprintf+0x25e>
 4ba:	8b2a                	mv	s6,a0
 4bc:	8a2e                	mv	s4,a1
 4be:	8bb2                	mv	s7,a2
  state = 0;
 ...
 4da:	47ac8c93          	addi	s9,s9,1146 # 950 <digits>
 4de:	a005                	j	4fe <vprintf+0x6a>
        putc(fd, c0);
 4e0:	85ca                	mv	a1,s2
 4e2:	855a                	mv	a0,s6
 4e4:	eedff0ef          	jal	ra,3d0 <putc>
 ...
 4fa:	1e090c63          	beqz	s2,6f2 <vprintf+0x25e>
    c0 = fmt[i] & 0xff;
 ...
 50c:	b7cd                	j	4ee <vprintf+0x5a>
      if(c0) c1 = fmt[i+1] & 0xff;
 50e:	cfa5                	beqz	a5,586 <vprintf+0xf2>
 ...
 51e:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 522:	03878a63          	beq	a5,s8,556 <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
 526:	05a78463          	beq	a5,s10,56e <vprintf+0xda>
      } else if(c0 == 'u'){
 52a:	0db78763          	beq	a5,s11,5f8 <vprintf+0x164>
 ...
 532:	10e78963          	beq	a5,a4,644 <vprintf+0x1b0>
 ...
 53a:	12e78e63          	beq	a5,a4,676 <vprintf+0x1e2>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
 53e:	07300713          	li	a4,115
 542:	16e78b63          	beq	a5,a4,6b8 <vprintf+0x224>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
 546:	05579063          	bne	a5,s5,586 <vprintf+0xf2>
        putc(fd, '%');
 54a:	85d6                	mv	a1,s5
 54c:	855a                	mv	a0,s6
 54e:	e83ff0ef          	jal	ra,3d0 <putc>
 ...
 562:	855a                	mv	a0,s6
 564:	e8bff0ef          	jal	ra,3ee <printint>
 568:	8bca                	mv	s7,s2
      state = 0;
 56a:	4981                	li	s3,0
 56c:	b749                	j	4ee <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'd'){
 56e:	03868663          	beq	a3,s8,59a <vprintf+0x106>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 572:	05a68163          	beq	a3,s10,5b4 <vprintf+0x120>
      } else if(c0 == 'l' && c1 == 'u'){
 576:	09b68d63          	beq	a3,s11,610 <vprintf+0x17c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 57a:	03a68f63          	beq	a3,s10,5b8 <vprintf+0x124>
      } else if(c0 == 'l' && c1 == 'x'){
 57e:	07800793          	li	a5,120
 582:	0cf68d63          	beq	a3,a5,65c <vprintf+0x1c8>
        putc(fd, '%');
 586:	85d6                	mv	a1,s5
 588:	855a                	mv	a0,s6
 58a:	e47ff0ef          	jal	ra,3d0 <putc>
        putc(fd, c0);
 58e:	85ca                	mv	a1,s2
 590:	855a                	mv	a0,s6
 592:	e3fff0ef          	jal	ra,3d0 <putc>
      state = 0;
 596:	4981                	li	s3,0
 598:	bf99                	j	4ee <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
 ...
 5a6:	855a                	mv	a0,s6
 5a8:	e47ff0ef          	jal	ra,3ee <printint>
        i += 1;
 ...
 5b0:	4981                	li	s3,0
        i += 1;
 5b2:	bf35                	j	4ee <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 5b4:	03860563          	beq	a2,s8,5de <vprintf+0x14a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 5b8:	07b60963          	beq	a2,s11,62a <vprintf+0x196>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 5bc:	07800793          	li	a5,120
 5c0:	fcf613e3          	bne	a2,a5,586 <vprintf+0xf2>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 5d0:	855a                	mv	a0,s6
 5d2:	e1dff0ef          	jal	ra,3ee <printint>
        i += 2;
 ...
 5ea:	855a                	mv	a0,s6
 5ec:	e03ff0ef          	jal	ra,3ee <printint>
        i += 2;
 ...
 604:	855a                	mv	a0,s6
 606:	de9ff0ef          	jal	ra,3ee <printint>
 60a:	8bca                	mv	s7,s2
      state = 0;
 60c:	4981                	li	s3,0
 60e:	b5c5                	j	4ee <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 0);
 ...
 61c:	855a                	mv	a0,s6
 61e:	dd1ff0ef          	jal	ra,3ee <printint>
        i += 1;
 ...
 636:	855a                	mv	a0,s6
 638:	db7ff0ef          	jal	ra,3ee <printint>
        i += 2;
 ...
 650:	855a                	mv	a0,s6
 652:	d9dff0ef          	jal	ra,3ee <printint>
 656:	8bca                	mv	s7,s2
      state = 0;
 658:	4981                	li	s3,0
 65a:	bd51                	j	4ee <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 668:	855a                	mv	a0,s6
 66a:	d85ff0ef          	jal	ra,3ee <printint>
        i += 1;
 ...
 686:	855a                	mv	a0,s6
 688:	d49ff0ef          	jal	ra,3d0 <putc>
  putc(fd, 'x');
 68c:	07800593          	li	a1,120
 690:	855a                	mv	a0,s6
 692:	d3fff0ef          	jal	ra,3d0 <putc>
 696:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 6a2:	855a                	mv	a0,s6
 6a4:	d2dff0ef          	jal	ra,3d0 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 6a8:	0992                	slli	s3,s3,0x4
 6aa:	397d                	addiw	s2,s2,-1
 6ac:	fe0916e3          	bnez	s2,698 <vprintf+0x204>
        printptr(fd, va_arg(ap, uint64));
 6b0:	f8843b83          	ld	s7,-120(s0)
      state = 0;
 6b4:	4981                	li	s3,0
 6b6:	bd25                	j	4ee <vprintf+0x5a>
        if((s = va_arg(ap, char*)) == 0)
 6b8:	008b8993          	addi	s3,s7,8
 6bc:	000bb903          	ld	s2,0(s7)
 6c0:	00090f63          	beqz	s2,6de <vprintf+0x24a>
        for(; *s; s++)
 6c4:	00094583          	lbu	a1,0(s2)
 6c8:	c195                	beqz	a1,6ec <vprintf+0x258>
          putc(fd, *s);
 6ca:	855a                	mv	a0,s6
 6cc:	d05ff0ef          	jal	ra,3d0 <putc>
        for(; *s; s++)
 6d0:	0905                	addi	s2,s2,1
 6d2:	00094583          	lbu	a1,0(s2)
 6d6:	f9f5                	bnez	a1,6ca <vprintf+0x236>
        if((s = va_arg(ap, char*)) == 0)
 6d8:	8bce                	mv	s7,s3
      state = 0;
 6da:	4981                	li	s3,0
 6dc:	bd09                	j	4ee <vprintf+0x5a>
          s = "(null)";
 6de:	00000917          	auipc	s2,0x0
 6e2:	26a90913          	addi	s2,s2,618 # 948 <malloc+0x154>
        for(; *s; s++)
 6e6:	02800593          	li	a1,40
 6ea:	b7c5                	j	6ca <vprintf+0x236>
        if((s = va_arg(ap, char*)) == 0)
 6ec:	8bce                	mv	s7,s3
      state = 0;
 6ee:	4981                	li	s3,0
 6f0:	bbfd                	j	4ee <vprintf+0x5a>
    }
  }
}
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 728:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
 72c:	8622                	mv	a2,s0
 72e:	d67ff0ef          	jal	ra,494 <vprintf>
}
...
printf(const char *fmt, ...)
{
 ...
 75c:	85aa                	mv	a1,a0
 75e:	4505                	li	a0,1
 760:	d35ff0ef          	jal	ra,494 <vprintf>
}
