...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	36278793          	addi	a5,a5,866 # 7370 <malloc+0x246c>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	f9a50513          	addi	a0,a0,-102 # 5000 <malloc+0xfc>
      6e:	5dd040ef          	jal	ra,4e4a <printf>
      exit(1);
      72:	4505                	li	a0,1
      ...
      94:	8082                	ret
{
      ...
      a4:	f8050513          	addi	a0,a0,-128 # 5020 <malloc+0x11c>
      a8:	5a3040ef          	jal	ra,4e4a <printf>
      exit(1);
      ac:	4505                	li	a0,1
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	f7850513          	addi	a0,a0,-136 # 5038 <malloc+0x134>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	f8250513          	addi	a0,a0,-126 # 5058 <malloc+0x154>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	f4e50513          	addi	a0,a0,-178 # 5040 <malloc+0x13c>
      fa:	551040ef          	jal	ra,4e4a <printf>
    exit(1);
      fe:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	f6250513          	addi	a0,a0,-158 # 5068 <malloc+0x164>
     10e:	53d040ef          	jal	ra,4e4a <printf>
    exit(1);
     112:	4505                	li	a0,1
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     180:	f1450513          	addi	a0,a0,-236 # 5090 <malloc+0x18c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	f0a50513          	addi	a0,a0,-246 # 50b0 <malloc+0x1ac>
     1ae:	49d040ef          	jal	ra,4e4a <printf>
    exit(1);
     1b2:	4505                	li	a0,1
...
000000000000022c <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	e2650513          	addi	a0,a0,-474 # 50e8 <malloc+0x1e4>
     2ca:	381040ef          	jal	ra,4e4a <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     ...
     2e2:	e2a50513          	addi	a0,a0,-470 # 5108 <malloc+0x204>
     2e6:	365040ef          	jal	ra,4e4a <printf>
        exit(1);
     2ea:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     304:	e2050513          	addi	a0,a0,-480 # 5120 <malloc+0x21c>
     308:	780040ef          	jal	ra,4a88 <unlink>
     30c:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     310:	00005997          	auipc	s3,0x5
     314:	e1098993          	addi	s3,s3,-496 # 5120 <malloc+0x21c>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     350:	dd450513          	addi	a0,a0,-556 # 5120 <malloc+0x21c>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     364:	d4858593          	addi	a1,a1,-696 # 50a8 <malloc+0x1a4>
     368:	6f0040ef          	jal	ra,4a58 <write>
     36c:	4785                	li	a5,1
     36e:	02f50d63          	beq	a0,a5,3a8 <badwrite+0xb8>
    printf("write failed\n");
     372:	00005517          	auipc	a0,0x5
     376:	dce50513          	addi	a0,a0,-562 # 5140 <malloc+0x23c>
     37a:	2d1040ef          	jal	ra,4e4a <printf>
    exit(1);
     37e:	4505                	li	a0,1
     380:	6b8040ef          	jal	ra,4a38 <exit>
      printf("open junk failed\n");
     384:	00005517          	auipc	a0,0x5
     388:	da450513          	addi	a0,a0,-604 # 5128 <malloc+0x224>
     38c:	2bf040ef          	jal	ra,4e4a <printf>
      exit(1);
     390:	4505                	li	a0,1
     392:	6a6040ef          	jal	ra,4a38 <exit>
    printf("open junk failed\n");
     396:	00005517          	auipc	a0,0x5
     39a:	d9250513          	addi	a0,a0,-622 # 5128 <malloc+0x224>
     39e:	2ad040ef          	jal	ra,4e4a <printf>
    exit(1);
     3a2:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3b2:	d7250513          	addi	a0,a0,-654 # 5120 <malloc+0x21c>
...
0000000000000480 <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     496:	ede78793          	addi	a5,a5,-290 # 7370 <malloc+0x246c>
     49a:	638c                	ld	a1,0(a5)
     49c:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c4:	c90a0a13          	addi	s4,s4,-880 # 5150 <malloc+0x24c>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     54a:	c1250513          	addi	a0,a0,-1006 # 5158 <malloc+0x254>
     54e:	0fd040ef          	jal	ra,4e4a <printf>
      exit(1);
     552:	4505                	li	a0,1
     ...
     560:	c1450513          	addi	a0,a0,-1004 # 5170 <malloc+0x26c>
     564:	0e7040ef          	jal	ra,4e4a <printf>
      exit(1);
     568:	4505                	li	a0,1
     ...
     576:	c2e50513          	addi	a0,a0,-978 # 51a0 <malloc+0x29c>
     57a:	0d1040ef          	jal	ra,4e4a <printf>
      exit(1);
     57e:	4505                	li	a0,1
     580:	4b8040ef          	jal	ra,4a38 <exit>
      printf("pipe() failed\n");
     584:	00005517          	auipc	a0,0x5
     588:	c4c50513          	addi	a0,a0,-948 # 51d0 <malloc+0x2cc>
     58c:	0bf040ef          	jal	ra,4e4a <printf>
      exit(1);
     590:	4505                	li	a0,1
     ...
     59e:	c4650513          	addi	a0,a0,-954 # 51e0 <malloc+0x2dc>
     5a2:	0a9040ef          	jal	ra,4e4a <printf>
      exit(1);
     5a6:	4505                	li	a0,1
...
00000000000005ac <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c4:	db078793          	addi	a5,a5,-592 # 7370 <malloc+0x246c>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f8:	c1ca0a13          	addi	s4,s4,-996 # 5210 <malloc+0x30c>
    n = write(fds[1], "x", 1);
     5fc:	00005a97          	auipc	s5,0x5
     600:	aaca8a93          	addi	s5,s5,-1364 # 50a8 <malloc+0x1a4>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     684:	b9850513          	addi	a0,a0,-1128 # 5218 <malloc+0x314>
     688:	7c2040ef          	jal	ra,4e4a <printf>
      exit(1);
     68c:	4505                	li	a0,1
     ...
     69a:	b9a50513          	addi	a0,a0,-1126 # 5230 <malloc+0x32c>
     69e:	7ac040ef          	jal	ra,4e4a <printf>
      exit(1);
     6a2:	4505                	li	a0,1
     6a4:	394040ef          	jal	ra,4a38 <exit>
      printf("pipe() failed\n");
     6a8:	00005517          	auipc	a0,0x5
     6ac:	b2850513          	addi	a0,a0,-1240 # 51d0 <malloc+0x2cc>
     6b0:	79a040ef          	jal	ra,4e4a <printf>
      exit(1);
     6b4:	4505                	li	a0,1
     6b6:	382040ef          	jal	ra,4a38 <exit>
      printf("pipe write failed\n");
     6ba:	00005517          	auipc	a0,0x5
     6be:	ba650513          	addi	a0,a0,-1114 # 5260 <malloc+0x35c>
     6c2:	788040ef          	jal	ra,4e4a <printf>
      exit(1);
     6c6:	4505                	li	a0,1
     ...
     6d4:	ba850513          	addi	a0,a0,-1112 # 5278 <malloc+0x374>
     6d8:	772040ef          	jal	ra,4e4a <printf>
      exit(1);
     6dc:	4505                	li	a0,1
...
00000000000006e2 <truncate1>:
{
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72e:	96650513          	addi	a0,a0,-1690 # 5090 <malloc+0x18c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     752:	94250513          	addi	a0,a0,-1726 # 5090 <malloc+0x18c>
     756:	322040ef          	jal	ra,4a78 <open>
     75a:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75c:	4581                	li	a1,0
     75e:	00005517          	auipc	a0,0x5
     762:	93250513          	addi	a0,a0,-1742 # 5090 <malloc+0x18c>
  ...
  write(fd1, "abcdef", 6);
     ...
     794:	b7858593          	addi	a1,a1,-1160 # 5308 <malloc+0x404>
     798:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7ca:	8ca50513          	addi	a0,a0,-1846 # 5090 <malloc+0x18c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fe:	aae50513          	addi	a0,a0,-1362 # 52a8 <malloc+0x3a4>
     802:	648040ef          	jal	ra,4e4a <printf>
    exit(1);
     806:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     812:	aba50513          	addi	a0,a0,-1350 # 52c8 <malloc+0x3c4>
     816:	634040ef          	jal	ra,4e4a <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     81a:	8652                	mv	a2,s4
     81c:	85d6                	mv	a1,s5
     81e:	00005517          	auipc	a0,0x5
     822:	aba50513          	addi	a0,a0,-1350 # 52d8 <malloc+0x3d4>
     826:	624040ef          	jal	ra,4e4a <printf>
    exit(1);
     82a:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     836:	ac650513          	addi	a0,a0,-1338 # 52f8 <malloc+0x3f4>
     83a:	610040ef          	jal	ra,4e4a <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83e:	8652                	mv	a2,s4
     840:	85d6                	mv	a1,s5
     842:	00005517          	auipc	a0,0x5
     846:	a9650513          	addi	a0,a0,-1386 # 52d8 <malloc+0x3d4>
     84a:	600040ef          	jal	ra,4e4a <printf>
    exit(1);
     84e:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85c:	ab850513          	addi	a0,a0,-1352 # 5310 <malloc+0x40c>
     860:	5ea040ef          	jal	ra,4e4a <printf>
    exit(1);
     864:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     872:	ac250513          	addi	a0,a0,-1342 # 5330 <malloc+0x42c>
     876:	5d4040ef          	jal	ra,4e4a <printf>
    exit(1);
     87a:	4505                	li	a0,1
...
0000000000000880 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89e:	ab650513          	addi	a0,a0,-1354 # 5350 <malloc+0x44c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b2:	aca98993          	addi	s3,s3,-1334 # 5378 <malloc+0x474>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b6:	00005a97          	auipc	s5,0x5
     8ba:	afaa8a93          	addi	s5,s5,-1286 # 53b0 <malloc+0x4ac>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f4:	a6050513          	addi	a0,a0,-1440 # 5350 <malloc+0x44c>
  ...
  if(unlink("small") < 0){
     ...
     924:	a3050513          	addi	a0,a0,-1488 # 5350 <malloc+0x44c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     94a:	a1250513          	addi	a0,a0,-1518 # 5358 <malloc+0x454>
     94e:	4fc040ef          	jal	ra,4e4a <printf>
    exit(1);
     952:	4505                	li	a0,1
     ...
     960:	a2c50513          	addi	a0,a0,-1492 # 5388 <malloc+0x484>
     964:	4e6040ef          	jal	ra,4e4a <printf>
      exit(1);
     968:	4505                	li	a0,1
     ...
     976:	a4e50513          	addi	a0,a0,-1458 # 53c0 <malloc+0x4bc>
     97a:	4d0040ef          	jal	ra,4e4a <printf>
      exit(1);
     97e:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     98a:	a6250513          	addi	a0,a0,-1438 # 53e8 <malloc+0x4e4>
     98e:	4bc040ef          	jal	ra,4e4a <printf>
    exit(1);
     992:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     99e:	a6e50513          	addi	a0,a0,-1426 # 5408 <malloc+0x504>
     9a2:	4a8040ef          	jal	ra,4e4a <printf>
    exit(1);
     9a6:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b2:	a7250513          	addi	a0,a0,-1422 # 5420 <malloc+0x51c>
     9b6:	494040ef          	jal	ra,4e4a <printf>
    exit(1);
     9ba:	4505                	li	a0,1
...
00000000000009c0 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9dc:	a6850513          	addi	a0,a0,-1432 # 5440 <malloc+0x53c>
  ...
  fd = open("big", O_RDONLY);
     ...
     a22:	a2250513          	addi	a0,a0,-1502 # 5440 <malloc+0x53c>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a62:	9ea50513          	addi	a0,a0,-1558 # 5448 <malloc+0x544>
     a66:	3e4040ef          	jal	ra,4e4a <printf>
    exit(1);
     a6a:	4505                	li	a0,1
     ...
     a78:	9f450513          	addi	a0,a0,-1548 # 5468 <malloc+0x564>
     a7c:	3ce040ef          	jal	ra,4e4a <printf>
      exit(1);
     a80:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8c:	a0850513          	addi	a0,a0,-1528 # 5490 <malloc+0x58c>
     a90:	3ba040ef          	jal	ra,4e4a <printf>
    exit(1);
     a94:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     aac:	99850513          	addi	a0,a0,-1640 # 5440 <malloc+0x53c>
     ...
     ad2:	9e250513          	addi	a0,a0,-1566 # 54b0 <malloc+0x5ac>
     ad6:	374040ef          	jal	ra,4e4a <printf>
        exit(1);
     ada:	4505                	li	a0,1
     ...
     ae8:	9f450513          	addi	a0,a0,-1548 # 54d8 <malloc+0x5d4>
     aec:	35e040ef          	jal	ra,4e4a <printf>
      exit(1);
     af0:	4505                	li	a0,1
     ...
     afe:	9f650513          	addi	a0,a0,-1546 # 54f0 <malloc+0x5ec>
     b02:	348040ef          	jal	ra,4e4a <printf>
      exit(1);
     b06:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b12:	a0a50513          	addi	a0,a0,-1526 # 5518 <malloc+0x614>
     b16:	334040ef          	jal	ra,4e4a <printf>
    exit(1);
     b1a:	4505                	li	a0,1
...
0000000000000b20 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b38:	9fc50513          	addi	a0,a0,-1540 # 5530 <malloc+0x62c>
  ...
  write(fd, "hello", SZ);
     ...
     b4c:	a1858593          	addi	a1,a1,-1512 # 5560 <malloc+0x65c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b60:	9d450513          	addi	a0,a0,-1580 # 5530 <malloc+0x62c>
  ...
  if(unlink("unlinkread") != 0){
     ...
     b72:	9c250513          	addi	a0,a0,-1598 # 5530 <malloc+0x62c>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b84:	9b050513          	addi	a0,a0,-1616 # 5530 <malloc+0x62c>
     b88:	6f1030ef          	jal	ra,4a78 <open>
     b8c:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     b8e:	460d                	li	a2,3
     b90:	00005597          	auipc	a1,0x5
     b94:	a1858593          	addi	a1,a1,-1512 # 55a8 <malloc+0x6a4>
  ...
  unlink("unlinkread");
     ...
     be8:	94c50513          	addi	a0,a0,-1716 # 5530 <malloc+0x62c>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c04:	94050513          	addi	a0,a0,-1728 # 5540 <malloc+0x63c>
     c08:	242040ef          	jal	ra,4e4a <printf>
    exit(1);
     c0c:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c18:	95450513          	addi	a0,a0,-1708 # 5568 <malloc+0x664>
     c1c:	22e040ef          	jal	ra,4e4a <printf>
    exit(1);
     c20:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2c:	96050513          	addi	a0,a0,-1696 # 5588 <malloc+0x684>
     c30:	21a040ef          	jal	ra,4e4a <printf>
    exit(1);
     c34:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c40:	97450513          	addi	a0,a0,-1676 # 55b0 <malloc+0x6ac>
     c44:	206040ef          	jal	ra,4e4a <printf>
    exit(1);
     c48:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c54:	98050513          	addi	a0,a0,-1664 # 55d0 <malloc+0x6cc>
     c58:	1f2040ef          	jal	ra,4e4a <printf>
    exit(1);
     c5c:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c68:	98c50513          	addi	a0,a0,-1652 # 55f0 <malloc+0x6ec>
     c6c:	1de040ef          	jal	ra,4e4a <printf>
    exit(1);
     c70:	4505                	li	a0,1
...
0000000000000c76 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb8:	8ac58593          	addi	a1,a1,-1876 # 5560 <malloc+0x65c>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d90:	89450513          	addi	a0,a0,-1900 # 5620 <malloc+0x71c>
     d94:	0b6040ef          	jal	ra,4e4a <printf>
    exit(1);
     d98:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da4:	89850513          	addi	a0,a0,-1896 # 5638 <malloc+0x734>
     da8:	0a2040ef          	jal	ra,4e4a <printf>
    exit(1);
     dac:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db8:	89c50513          	addi	a0,a0,-1892 # 5650 <malloc+0x74c>
     dbc:	08e040ef          	jal	ra,4e4a <printf>
    exit(1);
     dc0:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dcc:	8a850513          	addi	a0,a0,-1880 # 5670 <malloc+0x76c>
     dd0:	07a040ef          	jal	ra,4e4a <printf>
    exit(1);
     dd4:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     de0:	8c450513          	addi	a0,a0,-1852 # 56a0 <malloc+0x79c>
     de4:	066040ef          	jal	ra,4e4a <printf>
    exit(1);
     de8:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df4:	8c850513          	addi	a0,a0,-1848 # 56b8 <malloc+0x7b4>
     df8:	052040ef          	jal	ra,4e4a <printf>
    exit(1);
     dfc:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e08:	8cc50513          	addi	a0,a0,-1844 # 56d0 <malloc+0x7cc>
     e0c:	03e040ef          	jal	ra,4e4a <printf>
    exit(1);
     e10:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1c:	8e050513          	addi	a0,a0,-1824 # 56f8 <malloc+0x7f4>
     e20:	02a040ef          	jal	ra,4e4a <printf>
    exit(1);
     e24:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e30:	8fc50513          	addi	a0,a0,-1796 # 5728 <malloc+0x824>
     e34:	016040ef          	jal	ra,4e4a <printf>
    exit(1);
     e38:	4505                	li	a0,1
...
0000000000000e3e <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e5a:	8f298993          	addi	s3,s3,-1806 # 5748 <malloc+0x844>
     e5e:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e60:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e92:	8ca50513          	addi	a0,a0,-1846 # 5758 <malloc+0x854>
     e96:	7b5030ef          	jal	ra,4e4a <printf>
      exit(1);
     e9a:	4505                	li	a0,1
...
0000000000000ea0 <bigdir>:
{
  ...
  unlink("bd");
     ...
     eba:	8c250513          	addi	a0,a0,-1854 # 5778 <malloc+0x874>
     ebe:	3cb030ef          	jal	ra,4a88 <unlink>
  fd = open("bd", O_CREATE);
     ec2:	20000593          	li	a1,512
     ec6:	00005517          	auipc	a0,0x5
     eca:	8b250513          	addi	a0,a0,-1870 # 5778 <malloc+0x874>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee4:	898a0a13          	addi	s4,s4,-1896 # 5778 <malloc+0x874>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f32:	84a50513          	addi	a0,a0,-1974 # 5778 <malloc+0x874>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f9a:	7ea50513          	addi	a0,a0,2026 # 5780 <malloc+0x87c>
     f9e:	6ad030ef          	jal	ra,4e4a <printf>
    exit(1);
     fa2:	4505                	li	a0,1
     ...
     fb4:	7f050513          	addi	a0,a0,2032 # 57a0 <malloc+0x89c>
     fb8:	693030ef          	jal	ra,4e4a <printf>
      exit(1);
     fbc:	4505                	li	a0,1
     ...
     fc8:	80450513          	addi	a0,a0,-2044 # 57c8 <malloc+0x8c4>
     fcc:	67f030ef          	jal	ra,4e4a <printf>
      exit(1);
     fd0:	4505                	li	a0,1
...
0000000000001002 <badarg>:
{
    ...
    1020:	01c98993          	addi	s3,s3,28 # 5038 <malloc+0x134>
    argv[0] = (char*)0xffffffff;
...
0000000000001040 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1096:	88678793          	addi	a5,a5,-1914 # 6918 <malloc+0x1a14>
  ...
  if(pid == 0){
    ...
    10ea:	28a78793          	addi	a5,a5,650 # 7370 <malloc+0x246c>
    ...
    110e:	f2e50513          	addi	a0,a0,-210 # 5038 <malloc+0x134>
    ...
    1122:	75250513          	addi	a0,a0,1874 # 5870 <malloc+0x96c>
    1126:	525030ef          	jal	ra,4e4a <printf>
      exit(1);
    112a:	4505                	li	a0,1
    ...
    113a:	6b250513          	addi	a0,a0,1714 # 57e8 <malloc+0x8e4>
    113e:	50d030ef          	jal	ra,4e4a <printf>
    exit(1);
    1142:	4505                	li	a0,1
    ...
    1152:	6ba50513          	addi	a0,a0,1722 # 5808 <malloc+0x904>
    1156:	4f5030ef          	jal	ra,4e4a <printf>
    exit(1);
    115a:	4505                	li	a0,1
    ...
    116c:	6c050513          	addi	a0,a0,1728 # 5828 <malloc+0x924>
    1170:	4db030ef          	jal	ra,4e4a <printf>
    exit(1);
    1174:	4505                	li	a0,1
    ...
    1184:	6d050513          	addi	a0,a0,1744 # 5850 <malloc+0x94c>
    1188:	4c3030ef          	jal	ra,4e4a <printf>
    exit(1);
    118c:	4505                	li	a0,1
    118e:	0ab030ef          	jal	ra,4a38 <exit>
    printf("fork failed\n");
    1192:	00006517          	auipc	a0,0x6
    1196:	c8650513          	addi	a0,a0,-890 # 6e18 <malloc+0x1f14>
    119a:	4b1030ef          	jal	ra,4e4a <printf>
    exit(1);
    119e:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    11d0:	6cc50513          	addi	a0,a0,1740 # 5898 <malloc+0x994>
    11d4:	477030ef          	jal	ra,4e4a <printf>
    exit(1);
    11d8:	4505                	li	a0,1
...
00000000000011de <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11fa:	e9a50513          	addi	a0,a0,-358 # 5090 <malloc+0x18c>
  ...
  if(pid == 0){
    ...
    1218:	e7ca0a13          	addi	s4,s4,-388 # 5090 <malloc+0x18c>
      int n = write(fd, "1234567890", 10);
    121c:	00004a97          	auipc	s5,0x4
    1220:	6dca8a93          	addi	s5,s5,1756 # 58f8 <malloc+0x9f4>
      int fd = open("truncfile", O_WRONLY);
    1224:	4585                	li	a1,1
    1226:	8552                	mv	a0,s4
    ...
    1274:	65850513          	addi	a0,a0,1624 # 58c8 <malloc+0x9c4>
    1278:	3d3030ef          	jal	ra,4e4a <printf>
    exit(1);
    127c:	4505                	li	a0,1
    ...
    1288:	65c50513          	addi	a0,a0,1628 # 58e0 <malloc+0x9dc>
    128c:	3bf030ef          	jal	ra,4e4a <printf>
        exit(1);
    1290:	4505                	li	a0,1
    ...
    129e:	66e50513          	addi	a0,a0,1646 # 5908 <malloc+0xa04>
    12a2:	3a9030ef          	jal	ra,4e4a <printf>
        exit(1);
    12a6:	4505                	li	a0,1
    ...
    12b4:	de0a0a13          	addi	s4,s4,-544 # 5090 <malloc+0x18c>
    int n = write(fd, "xxx", 3);
    12b8:	00004a97          	auipc	s5,0x4
    12bc:	670a8a93          	addi	s5,s5,1648 # 5928 <malloc+0xa24>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    12f6:	d9e50513          	addi	a0,a0,-610 # 5090 <malloc+0x18c>
  ...
  exit(xstatus);
    ...
    130c:	5d850513          	addi	a0,a0,1496 # 58e0 <malloc+0x9dc>
    1310:	33b030ef          	jal	ra,4e4a <printf>
      exit(1);
    1314:	4505                	li	a0,1
    ...
    1322:	61250513          	addi	a0,a0,1554 # 5930 <malloc+0xa2c>
    1326:	325030ef          	jal	ra,4e4a <printf>
      exit(1);
    132a:	4505                	li	a0,1
...
0000000000001330 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1342:	cfa78793          	addi	a5,a5,-774 # 5038 <malloc+0x134>
    1346:	fcf43023          	sd	a5,-64(s0)
    134a:	00004797          	auipc	a5,0x4
    134e:	60678793          	addi	a5,a5,1542 # 5950 <malloc+0xa4c>
    1352:	fcf43423          	sd	a5,-56(s0)
    1356:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    135a:	00004517          	auipc	a0,0x4
    135e:	5fe50513          	addi	a0,a0,1534 # 5958 <malloc+0xa54>
  ...
  if(pid == 0) {
    ...
    1380:	5dc50513          	addi	a0,a0,1500 # 5958 <malloc+0xa54>
    ...
    1398:	5e450513          	addi	a0,a0,1508 # 5978 <malloc+0xa74>
    139c:	2af030ef          	jal	ra,4e4a <printf>
      exit(1);
    13a0:	4505                	li	a0,1
    ...
    13ac:	52050513          	addi	a0,a0,1312 # 58c8 <malloc+0x9c4>
    13b0:	29b030ef          	jal	ra,4e4a <printf>
     exit(1);
    13b4:	4505                	li	a0,1
    ...
    13c0:	5a450513          	addi	a0,a0,1444 # 5960 <malloc+0xa5c>
    13c4:	287030ef          	jal	ra,4e4a <printf>
      exit(1);
    13c8:	4505                	li	a0,1
    ...
    13d6:	c6650513          	addi	a0,a0,-922 # 5038 <malloc+0x134>
  ...
  if(xstatus != 0)
    ...
    13fe:	58e50513          	addi	a0,a0,1422 # 5988 <malloc+0xa84>
    1402:	249030ef          	jal	ra,4e4a <printf>
      exit(1);
    1406:	4505                	li	a0,1
    ...
    1412:	59250513          	addi	a0,a0,1426 # 59a0 <malloc+0xa9c>
    1416:	235030ef          	jal	ra,4e4a <printf>
    141a:	bfd1                	j	13ee <exectest+0xbe>
  fd = open("echo-ok", O_RDONLY);
    141c:	4581                	li	a1,0
    141e:	00004517          	auipc	a0,0x4
    1422:	53a50513          	addi	a0,a0,1338 # 5958 <malloc+0xa54>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1444:	fc850513          	addi	a0,a0,-56 # 5408 <malloc+0x504>
    1448:	203030ef          	jal	ra,4e4a <printf>
    exit(1);
    144c:	4505                	li	a0,1
    ...
    1458:	48c50513          	addi	a0,a0,1164 # 58e0 <malloc+0x9dc>
    145c:	1ef030ef          	jal	ra,4e4a <printf>
    exit(1);
    1460:	4505                	li	a0,1
    1462:	5d6030ef          	jal	ra,4a38 <exit>
  unlink("echo-ok");
    1466:	00004517          	auipc	a0,0x4
    146a:	4f250513          	addi	a0,a0,1266 # 5958 <malloc+0xa54>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1490:	52c50513          	addi	a0,a0,1324 # 59b8 <malloc+0xab4>
    1494:	1b7030ef          	jal	ra,4e4a <printf>
    exit(1);
    1498:	4505                	li	a0,1
...
00000000000014a4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1536:	49e50513          	addi	a0,a0,1182 # 59d0 <malloc+0xacc>
    153a:	111030ef          	jal	ra,4e4a <printf>
    exit(1);
    153e:	4505                	li	a0,1
    ...
    1564:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xfd>
{
    ...
    15a8:	44450513          	addi	a0,a0,1092 # 59e8 <malloc+0xae4>
    15ac:	09f030ef          	jal	ra,4e4a <printf>
        exit(1);
    15b0:	4505                	li	a0,1
    ...
    15bc:	44850513          	addi	a0,a0,1096 # 5a00 <malloc+0xafc>
    15c0:	08b030ef          	jal	ra,4e4a <printf>
}
    ...
    15ec:	43050513          	addi	a0,a0,1072 # 5a18 <malloc+0xb14>
    15f0:	05b030ef          	jal	ra,4e4a <printf>
      exit(1);
    15f4:	4505                	li	a0,1
    ...
    1618:	42450513          	addi	a0,a0,1060 # 5a38 <malloc+0xb34>
    161c:	02f030ef          	jal	ra,4e4a <printf>
    exit(1);
    1620:	4505                	li	a0,1
...
0000000000001626 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    167a:	25250513          	addi	a0,a0,594 # 58c8 <malloc+0x9c4>
    167e:	7cc030ef          	jal	ra,4e4a <printf>
      exit(1);
    1682:	4505                	li	a0,1
    ...
    168e:	3c650513          	addi	a0,a0,966 # 5a50 <malloc+0xb4c>
    1692:	7b8030ef          	jal	ra,4e4a <printf>
        exit(1);
    1696:	4505                	li	a0,1
    ...
    16a2:	3ca50513          	addi	a0,a0,970 # 5a68 <malloc+0xb64>
    16a6:	7a4030ef          	jal	ra,4e4a <printf>
        exit(1);
    16aa:	4505                	li	a0,1
...
00000000000016b6 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    16fe:	1ce50513          	addi	a0,a0,462 # 58c8 <malloc+0x9c4>
    1702:	748030ef          	jal	ra,4e4a <printf>
      exit(1);
    1706:	4505                	li	a0,1
    ...
    1716:	1b650513          	addi	a0,a0,438 # 58c8 <malloc+0x9c4>
    171a:	730030ef          	jal	ra,4e4a <printf>
        exit(1);
    171e:	4505                	li	a0,1
...
0000000000001728 <forkfork>:
{
    ...
    1774:	31850513          	addi	a0,a0,792 # 5a88 <malloc+0xb84>
    1778:	6d2030ef          	jal	ra,4e4a <printf>
      exit(1);
    177c:	4505                	li	a0,1
    177e:	2ba030ef          	jal	ra,4a38 <exit>
{
    ...
    17b0:	2ec50513          	addi	a0,a0,748 # 5a98 <malloc+0xb94>
    17b4:	696030ef          	jal	ra,4e4a <printf>
      exit(1);
    17b8:	4505                	li	a0,1
...
00000000000017be <reparent2>:
{
  ...
  exit(0);
    ...
    17ea:	63250513          	addi	a0,a0,1586 # 6e18 <malloc+0x1f14>
    17ee:	65c030ef          	jal	ra,4e4a <printf>
      exit(1);
    17f2:	4505                	li	a0,1
...
0000000000001806 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    186c:	06050513          	addi	a0,a0,96 # 58c8 <malloc+0x9c4>
    1870:	5da030ef          	jal	ra,4e4a <printf>
      exit(1);
    1874:	4505                	li	a0,1
    ...
    1890:	0d450513          	addi	a0,a0,212 # 5960 <malloc+0xa5c>
    1894:	5b6030ef          	jal	ra,4e4a <printf>
          exit(1);
    1898:	4505                	li	a0,1
    ...
    18ee:	1ce50513          	addi	a0,a0,462 # 5ab8 <malloc+0xbb4>
    18f2:	558030ef          	jal	ra,4e4a <printf>
            exit(1);
    18f6:	4505                	li	a0,1
    ...
    1912:	1c250513          	addi	a0,a0,450 # 5ad0 <malloc+0xbcc>
    1916:	534030ef          	jal	ra,4e4a <printf>
        exit(1);
    191a:	4505                	li	a0,1
    ...
    1968:	19450513          	addi	a0,a0,404 # 5af8 <malloc+0xbf4>
    196c:	4de030ef          	jal	ra,4e4a <printf>
        exit(1);
    1970:	4505                	li	a0,1
...
00000000000019de <linkunlink>:
{
  ...
  unlink("x");
    ...
    19fe:	6ae50513          	addi	a0,a0,1710 # 50a8 <malloc+0x1a4>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a32:	67aa8a93          	addi	s5,s5,1658 # 50a8 <malloc+0x1a4>
      link("cat", "x");
    1a36:	00004b97          	auipc	s7,0x4
    1a3a:	0eab8b93          	addi	s7,s7,234 # 5b20 <malloc+0xc1c>
    1a3e:	a025                	j	1a66 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a40:	85a6                	mv	a1,s1
    1a42:	00004517          	auipc	a0,0x4
    1a46:	e8650513          	addi	a0,a0,-378 # 58c8 <malloc+0x9c4>
    1a4a:	400030ef          	jal	ra,4e4a <printf>
    exit(1);
    1a4e:	4505                	li	a0,1
...
0000000000001ab8 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1ae4:	06050513          	addi	a0,a0,96 # 5b40 <malloc+0xc3c>
    1ae8:	362030ef          	jal	ra,4e4a <printf>
    exit(1);
    1aec:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    1b32:	ffa50513          	addi	a0,a0,-6 # 5b28 <malloc+0xc24>
    1b36:	314030ef          	jal	ra,4e4a <printf>
    exit(1);
    1b3a:	4505                	li	a0,1
    ...
    1b46:	02650513          	addi	a0,a0,38 # 5b68 <malloc+0xc64>
    1b4a:	300030ef          	jal	ra,4e4a <printf>
      exit(1);
    1b4e:	4505                	li	a0,1
    ...
    1b5a:	02a50513          	addi	a0,a0,42 # 5b80 <malloc+0xc7c>
    1b5e:	2ec030ef          	jal	ra,4e4a <printf>
    exit(1);
    1b62:	4505                	li	a0,1
...
0000000000001b68 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bca:	d0250513          	addi	a0,a0,-766 # 58c8 <malloc+0x9c4>
    1bce:	27c030ef          	jal	ra,4e4a <printf>
      exit(1);
    1bd2:	4505                	li	a0,1
    ...
    1be4:	fb850513          	addi	a0,a0,-72 # 5b98 <malloc+0xc94>
    1be8:	262030ef          	jal	ra,4e4a <printf>
      exit(1);
    1bec:	4505                	li	a0,1
...
0000000000001bf8 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c52:	c7a50513          	addi	a0,a0,-902 # 58c8 <malloc+0x9c4>
    1c56:	1f4030ef          	jal	ra,4e4a <printf>
      exit(1);
    1c5a:	4505                	li	a0,1
    ...
    1c76:	f4650513          	addi	a0,a0,-186 # 5bb8 <malloc+0xcb4>
    1c7a:	1d0030ef          	jal	ra,4e4a <printf>
      exit(1);
    1c7e:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cb8:	77f9                	lui	a5,0xffffe
    1cba:	97ba                	add	a5,a5,a4
    1cbc:	0007c603          	lbu	a2,0(a5) # ffffffffffffe000 <base+0xfffffffffffef388>
    1cc0:	85a6                	mv	a1,s1
    1cc2:	00004517          	auipc	a0,0x4
    1cc6:	f0e50513          	addi	a0,a0,-242 # 5bd0 <malloc+0xccc>
    1cca:	180030ef          	jal	ra,4e4a <printf>
    exit(1);
    1cce:	4505                	li	a0,1
    ...
    1cda:	bf250513          	addi	a0,a0,-1038 # 58c8 <malloc+0x9c4>
    1cde:	16c030ef          	jal	ra,4e4a <printf>
    exit(1);
    1ce2:	4505                	li	a0,1
...
0000000000001cee <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d02:	67278793          	addi	a5,a5,1650 # 7370 <malloc+0x246c>
  ...
  exit(0);
    ...
    1d68:	e9450513          	addi	a0,a0,-364 # 5bf8 <malloc+0xcf4>
    1d6c:	0de030ef          	jal	ra,4e4a <printf>
      exit(0);
    1d70:	4501                	li	a0,0
    ...
    1d7c:	b5050513          	addi	a0,a0,-1200 # 58c8 <malloc+0x9c4>
    1d80:	0ca030ef          	jal	ra,4e4a <printf>
      exit(1);
    1d84:	4505                	li	a0,1
...
0000000000001d90 <manywrites>:
{
  ...
  exit(0);
    ...
    1de0:	03c50513          	addi	a0,a0,60 # 6e18 <malloc+0x1f14>
    1de4:	066030ef          	jal	ra,4e4a <printf>
      exit(1);
    1de8:	4505                	li	a0,1
    ...
    1e6c:	db050513          	addi	a0,a0,-592 # 5c18 <malloc+0xd14>
    1e70:	7db020ef          	jal	ra,4e4a <printf>
            exit(1);
    1e74:	4505                	li	a0,1
    ...
    1e84:	28850513          	addi	a0,a0,648 # 5108 <malloc+0x204>
    1e88:	7c3020ef          	jal	ra,4e4a <printf>
            exit(1);
    1e8c:	4505                	li	a0,1
...
0000000000001e96 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1ef8:	a2478793          	addi	a5,a5,-1500 # 6918 <malloc+0x1a14>
  ...
  if(ret != -1){
    ...
    1f32:	d0250513          	addi	a0,a0,-766 # 5c30 <malloc+0xd2c>
    1f36:	715020ef          	jal	ra,4e4a <printf>
    exit(1);
    1f3a:	4505                	li	a0,1
    ...
    1f48:	8a450513          	addi	a0,a0,-1884 # 57e8 <malloc+0x8e4>
    1f4c:	6ff020ef          	jal	ra,4e4a <printf>
    exit(1);
    1f50:	4505                	li	a0,1
    ...
    1f5e:	8ae50513          	addi	a0,a0,-1874 # 5808 <malloc+0x904>
    1f62:	6e9020ef          	jal	ra,4e4a <printf>
    exit(1);
    1f66:	4505                	li	a0,1
    ...
    1f76:	8b650513          	addi	a0,a0,-1866 # 5828 <malloc+0x924>
    1f7a:	6d1020ef          	jal	ra,4e4a <printf>
    exit(1);
    1f7e:	4505                	li	a0,1
    ...
    1f8c:	8c850513          	addi	a0,a0,-1848 # 5850 <malloc+0x94c>
    1f90:	6bb020ef          	jal	ra,4e4a <printf>
    exit(1);
    1f94:	4505                	li	a0,1
...
0000000000001f9a <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1fc8:	cac50513          	addi	a0,a0,-852 # 5c70 <malloc+0xd6c>
  ...
  if(n >= 0){
    ...
    1ff2:	ca250513          	addi	a0,a0,-862 # 5c90 <malloc+0xd8c>
    1ff6:	655020ef          	jal	ra,4e4a <printf>
    exit(1);
    1ffa:	4505                	li	a0,1
    1ffc:	23d020ef          	jal	ra,4a38 <exit>
    printf("sbrk(rwsbrk) failed\n");
    2000:	00004517          	auipc	a0,0x4
    2004:	c3850513          	addi	a0,a0,-968 # 5c38 <malloc+0xd34>
    2008:	643020ef          	jal	ra,4e4a <printf>
    exit(1);
    200c:	4505                	li	a0,1
    200e:	22b020ef          	jal	ra,4a38 <exit>
    printf("sbrk(rwsbrk) shrink failed\n");
    2012:	00004517          	auipc	a0,0x4
    2016:	c3e50513          	addi	a0,a0,-962 # 5c50 <malloc+0xd4c>
    201a:	631020ef          	jal	ra,4e4a <printf>
    exit(1);
    201e:	4505                	li	a0,1
    2020:	219020ef          	jal	ra,4a38 <exit>
    printf("open(rwsbrk) failed\n");
    2024:	00004517          	auipc	a0,0x4
    2028:	c5450513          	addi	a0,a0,-940 # 5c78 <malloc+0xd74>
    202c:	61f020ef          	jal	ra,4e4a <printf>
    exit(1);
    2030:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2040:	c3450513          	addi	a0,a0,-972 # 5c70 <malloc+0xd6c>
    2044:	245020ef          	jal	ra,4a88 <unlink>
  fd = open("README", O_RDONLY);
    2048:	4581                	li	a1,0
    204a:	00003517          	auipc	a0,0x3
    204e:	1c650513          	addi	a0,a0,454 # 5210 <malloc+0x30c>
  ...
  if(n >= 0){
    ...
    2070:	c5450513          	addi	a0,a0,-940 # 5cc0 <malloc+0xdbc>
    2074:	5d7020ef          	jal	ra,4e4a <printf>
    exit(1);
    2078:	4505                	li	a0,1
    207a:	1bf020ef          	jal	ra,4a38 <exit>
    printf("open(rwsbrk) failed\n");
    207e:	00004517          	auipc	a0,0x4
    2082:	bfa50513          	addi	a0,a0,-1030 # 5c78 <malloc+0xd74>
    2086:	5c5020ef          	jal	ra,4e4a <printf>
    exit(1);
    208a:	4505                	li	a0,1
...
000000000000209c <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    20e6:	c0650513          	addi	a0,a0,-1018 # 5ce8 <malloc+0xde4>
    20ea:	561020ef          	jal	ra,4e4a <printf>
    exit(1);
    20ee:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2124:	be850513          	addi	a0,a0,-1048 # 5d08 <malloc+0xe04>
    2128:	523020ef          	jal	ra,4e4a <printf>
    exit(1);
    212c:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2170:	bfc50513          	addi	a0,a0,-1028 # 5d68 <malloc+0xe64>
    2174:	4d7020ef          	jal	ra,4e4a <printf>
    exit(1);
    2178:	4505                	li	a0,1
    ...
    218a:	ba250513          	addi	a0,a0,-1118 # 5d28 <malloc+0xe24>
    218e:	4bd020ef          	jal	ra,4e4a <printf>
      exit(1);
    2192:	4505                	li	a0,1
    ...
    219e:	bae50513          	addi	a0,a0,-1106 # 5d48 <malloc+0xe44>
    21a2:	4a9020ef          	jal	ra,4e4a <printf>
    exit(1);
    21a6:	4505                	li	a0,1
...
00000000000021c6 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    22a0:	aec50513          	addi	a0,a0,-1300 # 5d88 <malloc+0xe84>
    22a4:	3a7020ef          	jal	ra,4e4a <printf>
    exit(1);
    22a8:	4505                	li	a0,1
    ...
    22b4:	b2050513          	addi	a0,a0,-1248 # 5dd0 <malloc+0xecc>
    22b8:	393020ef          	jal	ra,4e4a <printf>
    exit(1);
    22bc:	4505                	li	a0,1
    ...
    22cc:	b2850513          	addi	a0,a0,-1240 # 5df0 <malloc+0xeec>
    22d0:	37b020ef          	jal	ra,4e4a <printf>
    exit(1);
    22d4:	4505                	li	a0,1
    ...
    22e4:	b5050513          	addi	a0,a0,-1200 # 5e30 <malloc+0xf2c>
    22e8:	363020ef          	jal	ra,4e4a <printf>
    exit(1);
    22ec:	4505                	li	a0,1
    ...
    22f8:	b6c50513          	addi	a0,a0,-1172 # 5e60 <malloc+0xf5c>
    22fc:	34f020ef          	jal	ra,4e4a <printf>
    exit(1);
    2300:	4505                	li	a0,1
    ...
    2310:	b8c50513          	addi	a0,a0,-1140 # 5e98 <malloc+0xf94>
    2314:	337020ef          	jal	ra,4e4a <printf>
    exit(1);
    2318:	4505                	li	a0,1
...
000000000000231e <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    233e:	b8650513          	addi	a0,a0,-1146 # 5ec0 <malloc+0xfbc>
    2342:	736020ef          	jal	ra,4a78 <open>
    2346:	84aa                	mv	s1,a0
  unlink("sbrk");
    2348:	00004517          	auipc	a0,0x4
    234c:	b7850513          	addi	a0,a0,-1160 # 5ec0 <malloc+0xfbc>
  ...
  if(pipe((int *) a) != 0){
    ...
    238c:	b4050513          	addi	a0,a0,-1216 # 5ec8 <malloc+0xfc4>
    2390:	2bb020ef          	jal	ra,4e4a <printf>
    exit(1);
    2394:	4505                	li	a0,1
    ...
    23a0:	b4450513          	addi	a0,a0,-1212 # 5ee0 <malloc+0xfdc>
    23a4:	2a7020ef          	jal	ra,4e4a <printf>
    exit(1);
    23a8:	4505                	li	a0,1
    ...
    23b4:	62050513          	addi	a0,a0,1568 # 59d0 <malloc+0xacc>
    23b8:	293020ef          	jal	ra,4e4a <printf>
    exit(1);
    23bc:	4505                	li	a0,1
...
00000000000023c2 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    23d6:	b2650513          	addi	a0,a0,-1242 # 5ef8 <malloc+0xff4>
  ...
  close(fd);
    ...
    240e:	4d650513          	addi	a0,a0,1238 # 58e0 <malloc+0x9dc>
    2412:	239020ef          	jal	ra,4e4a <printf>
    exit(1);
    2416:	4505                	li	a0,1
...
000000000000241c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2444:	9d850513          	addi	a0,a0,-1576 # 6e18 <malloc+0x1f14>
    2448:	203020ef          	jal	ra,4e4a <printf>
    exit(1);
    244c:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    247e:	99e50513          	addi	a0,a0,-1634 # 6e18 <malloc+0x1f14>
    2482:	1c9020ef          	jal	ra,4e4a <printf>
    exit(1);
    2486:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24be:	95e50513          	addi	a0,a0,-1698 # 6e18 <malloc+0x1f14>
    24c2:	189020ef          	jal	ra,4e4a <printf>
    exit(1);
    24c6:	4505                	li	a0,1
...
00000000000025a8 <execout>:
{
  ...
  exit(0);
    ...
    25de:	83e50513          	addi	a0,a0,-1986 # 6e18 <malloc+0x1f14>
    25e2:	069020ef          	jal	ra,4e4a <printf>
      exit(1);
    25e6:	4505                	li	a0,1
    ...
    261e:	a1e50513          	addi	a0,a0,-1506 # 5038 <malloc+0x134>
    2622:	faa43c23          	sd	a0,-72(s0)
    2626:	00003797          	auipc	a5,0x3
    262a:	a8278793          	addi	a5,a5,-1406 # 50a8 <malloc+0x1a4>
...
0000000000002644 <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2674:	91050513          	addi	a0,a0,-1776 # 5f80 <malloc+0x107c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    268a:	97250513          	addi	a0,a0,-1678 # 5ff8 <malloc+0x10f4>
  ...
  unlink("12345678901234");
    ...
    270e:	7f650513          	addi	a0,a0,2038 # 5f00 <malloc+0xffc>
    2712:	738020ef          	jal	ra,4e4a <printf>
    exit(1);
    2716:	4505                	li	a0,1
    ...
    2722:	82a50513          	addi	a0,a0,-2006 # 5f48 <malloc+0x1044>
    2726:	724020ef          	jal	ra,4e4a <printf>
    exit(1);
    272a:	4505                	li	a0,1
    ...
    2736:	87e50513          	addi	a0,a0,-1922 # 5fb0 <malloc+0x10ac>
    273a:	710020ef          	jal	ra,4e4a <printf>
    exit(1);
    273e:	4505                	li	a0,1
    ...
    274a:	8e250513          	addi	a0,a0,-1822 # 6028 <malloc+0x1124>
    274e:	6fc020ef          	jal	ra,4e4a <printf>
    exit(1);
    2752:	4505                	li	a0,1
    ...
    275e:	92e50513          	addi	a0,a0,-1746 # 6088 <malloc+0x1184>
    2762:	6e8020ef          	jal	ra,4e4a <printf>
    exit(1);
    2766:	4505                	li	a0,1
    ...
    2772:	97250513          	addi	a0,a0,-1678 # 60e0 <malloc+0x11dc>
    2776:	6d4020ef          	jal	ra,4e4a <printf>
    exit(1);
    277a:	4505                	li	a0,1
...
0000000000002780 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    27ba:	96250513          	addi	a0,a0,-1694 # 6118 <malloc+0x1214>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    27e6:	94650513          	addi	a0,a0,-1722 # 6128 <malloc+0x1224>
    27ea:	660020ef          	jal	ra,4e4a <printf>
      break;
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    298a:	7c250513          	addi	a0,a0,1986 # 6148 <malloc+0x1244>
    298e:	4bc020ef          	jal	ra,4e4a <printf>
...
0000000000002994 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    29f0:	79450513          	addi	a0,a0,1940 # 6180 <malloc+0x127c>
    29f4:	456020ef          	jal	ra,4e4a <printf>
    exit(1);
    29f8:	4505                	li	a0,1
    ...
    2a04:	79850513          	addi	a0,a0,1944 # 6198 <malloc+0x1294>
    2a08:	442020ef          	jal	ra,4e4a <printf>
    exit(1);
    2a0c:	4505                	li	a0,1
    ...
    2a18:	7b450513          	addi	a0,a0,1972 # 61c8 <malloc+0x12c4>
    2a1c:	42e020ef          	jal	ra,4e4a <printf>
    exit(1);
    2a20:	4505                	li	a0,1
    ...
    2a2c:	7c850513          	addi	a0,a0,1992 # 61f0 <malloc+0x12ec>
    2a30:	41a020ef          	jal	ra,4e4a <printf>
    exit(1);
    2a34:	4505                	li	a0,1
...
0000000000002a3a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2a8c:	e4050513          	addi	a0,a0,-448 # 58c8 <malloc+0x9c4>
    2a90:	3ba020ef          	jal	ra,4e4a <printf>
    exit(1);
    2a94:	4505                	li	a0,1
    ...
    2aa0:	6e450513          	addi	a0,a0,1764 # 6180 <malloc+0x127c>
    2aa4:	3a6020ef          	jal	ra,4e4a <printf>
      exit(1);
    2aa8:	4505                	li	a0,1
    ...
    2ab4:	75850513          	addi	a0,a0,1880 # 6208 <malloc+0x1304>
    2ab8:	392020ef          	jal	ra,4e4a <printf>
      exit(1);
    2abc:	4505                	li	a0,1
    ...
    2ac8:	70450513          	addi	a0,a0,1796 # 61c8 <malloc+0x12c4>
    2acc:	37e020ef          	jal	ra,4e4a <printf>
      exit(1);
    2ad0:	4505                	li	a0,1
...
0000000000002ae6 <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b42:	64250513          	addi	a0,a0,1602 # 6180 <malloc+0x127c>
    2b46:	304020ef          	jal	ra,4e4a <printf>
    exit(1);
    2b4a:	4505                	li	a0,1
    ...
    2b56:	6d650513          	addi	a0,a0,1750 # 6228 <malloc+0x1324>
    2b5a:	2f0020ef          	jal	ra,4e4a <printf>
    exit(1);
    2b5e:	4505                	li	a0,1
    ...
    2b6a:	6e250513          	addi	a0,a0,1762 # 6248 <malloc+0x1344>
    2b6e:	2dc020ef          	jal	ra,4e4a <printf>
    exit(1);
    2b72:	4505                	li	a0,1
    ...
    2b7e:	6e650513          	addi	a0,a0,1766 # 6260 <malloc+0x135c>
    2b82:	2c8020ef          	jal	ra,4e4a <printf>
    exit(1);
    2b86:	4505                	li	a0,1
...
0000000000002b8c <subdir>:
{
  ...
  unlink("ff");
    ...
    2b9e:	80e50513          	addi	a0,a0,-2034 # 63a8 <malloc+0x14a4>
    2ba2:	6e7010ef          	jal	ra,4a88 <unlink>
  if(mkdir("dd") != 0){
    2ba6:	00003517          	auipc	a0,0x3
    2baa:	6d250513          	addi	a0,a0,1746 # 6278 <malloc+0x1374>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2bbe:	6de50513          	addi	a0,a0,1758 # 6298 <malloc+0x1394>
  ...
  write(fd, "ff", 2);
    ...
    2bd2:	7da58593          	addi	a1,a1,2010 # 63a8 <malloc+0x14a4>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2c08:	71450513          	addi	a0,a0,1812 # 6318 <malloc+0x1414>
  ...
  write(fd, "FF", 2);
    ...
    2c1c:	73058593          	addi	a1,a1,1840 # 6348 <malloc+0x1444>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c30:	72450513          	addi	a0,a0,1828 # 6350 <malloc+0x144c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d16:	60650513          	addi	a0,a0,1542 # 6318 <malloc+0x1414>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d2a:	80a50513          	addi	a0,a0,-2038 # 6530 <malloc+0x162c>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d3e:	82650513          	addi	a0,a0,-2010 # 6560 <malloc+0x165c>
  ...
  if(unlink("dd") < 0){
    ...
    2e9c:	3e850513          	addi	a0,a0,1000 # 6280 <malloc+0x137c>
    2ea0:	7ab010ef          	jal	ra,4e4a <printf>
    exit(1);
    2ea4:	4505                	li	a0,1
    ...
    2eb0:	3f450513          	addi	a0,a0,1012 # 62a0 <malloc+0x139c>
    2eb4:	797010ef          	jal	ra,4e4a <printf>
    exit(1);
    2eb8:	4505                	li	a0,1
    ...
    2ec4:	40050513          	addi	a0,a0,1024 # 62c0 <malloc+0x13bc>
    2ec8:	783010ef          	jal	ra,4e4a <printf>
    exit(1);
    2ecc:	4505                	li	a0,1
    ...
    2ed8:	42450513          	addi	a0,a0,1060 # 62f8 <malloc+0x13f4>
    2edc:	76f010ef          	jal	ra,4e4a <printf>
    exit(1);
    2ee0:	4505                	li	a0,1
    ...
    2eec:	44050513          	addi	a0,a0,1088 # 6328 <malloc+0x1424>
    2ef0:	75b010ef          	jal	ra,4e4a <printf>
    exit(1);
    2ef4:	4505                	li	a0,1
    ...
    2f00:	46450513          	addi	a0,a0,1124 # 6360 <malloc+0x145c>
    2f04:	747010ef          	jal	ra,4e4a <printf>
    exit(1);
    2f08:	4505                	li	a0,1
    ...
    2f14:	47050513          	addi	a0,a0,1136 # 6380 <malloc+0x147c>
    2f18:	733010ef          	jal	ra,4e4a <printf>
    exit(1);
    2f1c:	4505                	li	a0,1
    ...
    2f28:	48c50513          	addi	a0,a0,1164 # 63b0 <malloc+0x14ac>
    2f2c:	71f010ef          	jal	ra,4e4a <printf>
    exit(1);
    2f30:	4505                	li	a0,1
    ...
    2f3c:	4a050513          	addi	a0,a0,1184 # 63d8 <malloc+0x14d4>
    2f40:	70b010ef          	jal	ra,4e4a <printf>
    exit(1);
    2f44:	4505                	li	a0,1
    ...
    2f50:	4ac50513          	addi	a0,a0,1196 # 63f8 <malloc+0x14f4>
    2f54:	6f7010ef          	jal	ra,4e4a <printf>
    exit(1);
    2f58:	4505                	li	a0,1
    ...
    2f64:	4c050513          	addi	a0,a0,1216 # 6420 <malloc+0x151c>
    2f68:	6e3010ef          	jal	ra,4e4a <printf>
    exit(1);
    2f6c:	4505                	li	a0,1
    ...
    2f78:	4d450513          	addi	a0,a0,1236 # 6448 <malloc+0x1544>
    2f7c:	6cf010ef          	jal	ra,4e4a <printf>
    exit(1);
    2f80:	4505                	li	a0,1
    ...
    2f8c:	4f050513          	addi	a0,a0,1264 # 6478 <malloc+0x1574>
    2f90:	6bb010ef          	jal	ra,4e4a <printf>
    exit(1);
    2f94:	4505                	li	a0,1
    ...
    2fa0:	50c50513          	addi	a0,a0,1292 # 64a8 <malloc+0x15a4>
    2fa4:	6a7010ef          	jal	ra,4e4a <printf>
    exit(1);
    2fa8:	4505                	li	a0,1
    ...
    2fb4:	51050513          	addi	a0,a0,1296 # 64c0 <malloc+0x15bc>
    2fb8:	693010ef          	jal	ra,4e4a <printf>
    exit(1);
    2fbc:	4505                	li	a0,1
    ...
    2fc8:	51c50513          	addi	a0,a0,1308 # 64e0 <malloc+0x15dc>
    2fcc:	67f010ef          	jal	ra,4e4a <printf>
    exit(1);
    2fd0:	4505                	li	a0,1
    ...
    2fdc:	52850513          	addi	a0,a0,1320 # 6500 <malloc+0x15fc>
    2fe0:	66b010ef          	jal	ra,4e4a <printf>
    exit(1);
    2fe4:	4505                	li	a0,1
    ...
    2ff0:	55450513          	addi	a0,a0,1364 # 6540 <malloc+0x163c>
    2ff4:	657010ef          	jal	ra,4e4a <printf>
    exit(1);
    2ff8:	4505                	li	a0,1
    ...
    3004:	57050513          	addi	a0,a0,1392 # 6570 <malloc+0x166c>
    3008:	643010ef          	jal	ra,4e4a <printf>
    exit(1);
    300c:	4505                	li	a0,1
    ...
    3018:	57c50513          	addi	a0,a0,1404 # 6590 <malloc+0x168c>
    301c:	62f010ef          	jal	ra,4e4a <printf>
    exit(1);
    3020:	4505                	li	a0,1
    ...
    302c:	58850513          	addi	a0,a0,1416 # 65b0 <malloc+0x16ac>
    3030:	61b010ef          	jal	ra,4e4a <printf>
    exit(1);
    3034:	4505                	li	a0,1
    ...
    3040:	59450513          	addi	a0,a0,1428 # 65d0 <malloc+0x16cc>
    3044:	607010ef          	jal	ra,4e4a <printf>
    exit(1);
    3048:	4505                	li	a0,1
    ...
    3054:	5b050513          	addi	a0,a0,1456 # 6600 <malloc+0x16fc>
    3058:	5f3010ef          	jal	ra,4e4a <printf>
    exit(1);
    305c:	4505                	li	a0,1
    ...
    3068:	5c450513          	addi	a0,a0,1476 # 6628 <malloc+0x1724>
    306c:	5df010ef          	jal	ra,4e4a <printf>
    exit(1);
    3070:	4505                	li	a0,1
    ...
    307c:	5d850513          	addi	a0,a0,1496 # 6650 <malloc+0x174c>
    3080:	5cb010ef          	jal	ra,4e4a <printf>
    exit(1);
    3084:	4505                	li	a0,1
    ...
    3090:	5ec50513          	addi	a0,a0,1516 # 6678 <malloc+0x1774>
    3094:	5b7010ef          	jal	ra,4e4a <printf>
    exit(1);
    3098:	4505                	li	a0,1
    ...
    30a4:	5f850513          	addi	a0,a0,1528 # 6698 <malloc+0x1794>
    30a8:	5a3010ef          	jal	ra,4e4a <printf>
    exit(1);
    30ac:	4505                	li	a0,1
    ...
    30b8:	60450513          	addi	a0,a0,1540 # 66b8 <malloc+0x17b4>
    30bc:	58f010ef          	jal	ra,4e4a <printf>
    exit(1);
    30c0:	4505                	li	a0,1
    ...
    30cc:	61850513          	addi	a0,a0,1560 # 66e0 <malloc+0x17dc>
    30d0:	57b010ef          	jal	ra,4e4a <printf>
    exit(1);
    30d4:	4505                	li	a0,1
    ...
    30e0:	62450513          	addi	a0,a0,1572 # 6700 <malloc+0x17fc>
    30e4:	567010ef          	jal	ra,4e4a <printf>
    exit(1);
    30e8:	4505                	li	a0,1
    ...
    30f4:	63050513          	addi	a0,a0,1584 # 6720 <malloc+0x181c>
    30f8:	553010ef          	jal	ra,4e4a <printf>
    exit(1);
    30fc:	4505                	li	a0,1
    ...
    3108:	64450513          	addi	a0,a0,1604 # 6748 <malloc+0x1844>
    310c:	53f010ef          	jal	ra,4e4a <printf>
    exit(1);
    3110:	4505                	li	a0,1
    ...
    311c:	2c050513          	addi	a0,a0,704 # 63d8 <malloc+0x14d4>
    3120:	52b010ef          	jal	ra,4e4a <printf>
    exit(1);
    3124:	4505                	li	a0,1
    ...
    3130:	63c50513          	addi	a0,a0,1596 # 6768 <malloc+0x1864>
    3134:	517010ef          	jal	ra,4e4a <printf>
    exit(1);
    3138:	4505                	li	a0,1
    ...
    3144:	64850513          	addi	a0,a0,1608 # 6788 <malloc+0x1884>
    3148:	503010ef          	jal	ra,4e4a <printf>
    exit(1);
    314c:	4505                	li	a0,1
    ...
    3158:	66450513          	addi	a0,a0,1636 # 67b8 <malloc+0x18b4>
    315c:	4ef010ef          	jal	ra,4e4a <printf>
    exit(1);
    3160:	4505                	li	a0,1
    ...
    316c:	67050513          	addi	a0,a0,1648 # 67d8 <malloc+0x18d4>
    3170:	4db010ef          	jal	ra,4e4a <printf>
    exit(1);
    3174:	4505                	li	a0,1
...
000000000000317a <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    3206:	5f650513          	addi	a0,a0,1526 # 67f8 <malloc+0x18f4>
    320a:	441010ef          	jal	ra,4e4a <printf>
    exit(1);
    320e:	4505                	li	a0,1
    ...
    321a:	5fa50513          	addi	a0,a0,1530 # 6810 <malloc+0x190c>
    321e:	42d010ef          	jal	ra,4e4a <printf>
    exit(1);
    3222:	4505                	li	a0,1
    ...
    322e:	5fe50513          	addi	a0,a0,1534 # 6828 <malloc+0x1924>
    3232:	419010ef          	jal	ra,4e4a <printf>
    exit(1);
    3236:	4505                	li	a0,1
    ...
    3242:	60250513          	addi	a0,a0,1538 # 6840 <malloc+0x193c>
    3246:	405010ef          	jal	ra,4e4a <printf>
    exit(1);
    324a:	4505                	li	a0,1
    ...
    3256:	f9e50513          	addi	a0,a0,-98 # 61f0 <malloc+0x12ec>
    325a:	3f1010ef          	jal	ra,4e4a <printf>
    exit(1);
    325e:	4505                	li	a0,1
    ...
    326a:	5fa50513          	addi	a0,a0,1530 # 6860 <malloc+0x195c>
    326e:	3dd010ef          	jal	ra,4e4a <printf>
    exit(1);
    3272:	4505                	li	a0,1
    ...
    327e:	60e50513          	addi	a0,a0,1550 # 6888 <malloc+0x1984>
    3282:	3c9010ef          	jal	ra,4e4a <printf>
    exit(1);
    3286:	4505                	li	a0,1
    ...
    3292:	61a50513          	addi	a0,a0,1562 # 68a8 <malloc+0x19a4>
    3296:	3b5010ef          	jal	ra,4e4a <printf>
    exit(1);
    329a:	4505                	li	a0,1
...
00000000000032a0 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    32b6:	61650513          	addi	a0,a0,1558 # 68c8 <malloc+0x19c4>
  ...
  if(chdir("dirfile") == 0){
    ...
    32ca:	60250513          	addi	a0,a0,1538 # 68c8 <malloc+0x19c4>
    32ce:	7da010ef          	jal	ra,4aa8 <chdir>
    32d2:	c569                	beqz	a0,339c <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    32d4:	4581                	li	a1,0
    32d6:	00003517          	auipc	a0,0x3
    32da:	63a50513          	addi	a0,a0,1594 # 6910 <malloc+0x1a0c>
  ...
  fd = open(".", 0);
    ...
    335a:	3ca50513          	addi	a0,a0,970 # 5720 <malloc+0x81c>
    335e:	71a010ef          	jal	ra,4a78 <open>
    3362:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    3364:	4605                	li	a2,1
    3366:	00002597          	auipc	a1,0x2
    336a:	d4258593          	addi	a1,a1,-702 # 50a8 <malloc+0x1a4>
  ...
  close(fd);
    ...
    338e:	54650513          	addi	a0,a0,1350 # 68d0 <malloc+0x19cc>
    3392:	2b9010ef          	jal	ra,4e4a <printf>
    exit(1);
    3396:	4505                	li	a0,1
    ...
    33a2:	55250513          	addi	a0,a0,1362 # 68f0 <malloc+0x19ec>
    33a6:	2a5010ef          	jal	ra,4e4a <printf>
    exit(1);
    33aa:	4505                	li	a0,1
    ...
    33b6:	56e50513          	addi	a0,a0,1390 # 6920 <malloc+0x1a1c>
    33ba:	291010ef          	jal	ra,4e4a <printf>
    exit(1);
    33be:	4505                	li	a0,1
    ...
    33ca:	55a50513          	addi	a0,a0,1370 # 6920 <malloc+0x1a1c>
    33ce:	27d010ef          	jal	ra,4e4a <printf>
    exit(1);
    33d2:	4505                	li	a0,1
    ...
    33de:	56e50513          	addi	a0,a0,1390 # 6948 <malloc+0x1a44>
    33e2:	269010ef          	jal	ra,4e4a <printf>
    exit(1);
    33e6:	4505                	li	a0,1
    ...
    33f2:	58250513          	addi	a0,a0,1410 # 6970 <malloc+0x1a6c>
    33f6:	255010ef          	jal	ra,4e4a <printf>
    exit(1);
    33fa:	4505                	li	a0,1
    ...
    3406:	59650513          	addi	a0,a0,1430 # 6998 <malloc+0x1a94>
    340a:	241010ef          	jal	ra,4e4a <printf>
    exit(1);
    340e:	4505                	li	a0,1
    ...
    341a:	5aa50513          	addi	a0,a0,1450 # 69c0 <malloc+0x1abc>
    341e:	22d010ef          	jal	ra,4e4a <printf>
    exit(1);
    3422:	4505                	li	a0,1
    ...
    342e:	5b650513          	addi	a0,a0,1462 # 69e0 <malloc+0x1adc>
    3432:	219010ef          	jal	ra,4e4a <printf>
    exit(1);
    3436:	4505                	li	a0,1
    ...
    3442:	5ca50513          	addi	a0,a0,1482 # 6a08 <malloc+0x1b04>
    3446:	205010ef          	jal	ra,4e4a <printf>
    exit(1);
    344a:	4505                	li	a0,1
...
0000000000003450 <iref>:
{
    ...
    346e:	5b6a0a13          	addi	s4,s4,1462 # 6a20 <malloc+0x1b1c>
    mkdir("");
    3472:	00003497          	auipc	s1,0x3
    3476:	0b648493          	addi	s1,s1,182 # 6528 <malloc+0x1624>
    link("README", "");
    347a:	00002a97          	auipc	s5,0x2
    347e:	d96a8a93          	addi	s5,s5,-618 # 5210 <malloc+0x30c>
    fd = open("xx", O_CREATE);
    3482:	00003997          	auipc	s3,0x3
    3486:	49698993          	addi	s3,s3,1174 # 6918 <malloc+0x1a14>
    348a:	a835                	j	34c6 <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    348c:	85da                	mv	a1,s6
    348e:	00003517          	auipc	a0,0x3
    3492:	59a50513          	addi	a0,a0,1434 # 6a28 <malloc+0x1b24>
    3496:	1b5010ef          	jal	ra,4e4a <printf>
      exit(1);
    349a:	4505                	li	a0,1
    ...
    34a6:	59e50513          	addi	a0,a0,1438 # 6a40 <malloc+0x1b3c>
    34aa:	1a1010ef          	jal	ra,4e4a <printf>
      exit(1);
    34ae:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    350e:	d3698993          	addi	s3,s3,-714 # 6240 <malloc+0x133c>
    unlink("irefd");
    3512:	00003917          	auipc	s2,0x3
    3516:	50e90913          	addi	s2,s2,1294 # 6a20 <malloc+0x1b1c>
    chdir("..");
    351a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    352e:	cbe50513          	addi	a0,a0,-834 # 61e8 <malloc+0x12e4>
...
000000000000354a <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    355a:	50250513          	addi	a0,a0,1282 # 6a58 <malloc+0x1b54>
  ...
  if(pid == 0){
    ...
    3576:	4e650513          	addi	a0,a0,1254 # 6a58 <malloc+0x1b54>
    ...
    3588:	4f450513          	addi	a0,a0,1268 # 6a78 <malloc+0x1b74>
    358c:	0bf010ef          	jal	ra,4e4a <printf>
      exit(1);
    3590:	4505                	li	a0,1
    ...
    359c:	4c850513          	addi	a0,a0,1224 # 6a60 <malloc+0x1b5c>
    35a0:	0ab010ef          	jal	ra,4e4a <printf>
    exit(1);
    35a4:	4505                	li	a0,1
    ...
    35b0:	31c50513          	addi	a0,a0,796 # 58c8 <malloc+0x9c4>
    35b4:	097010ef          	jal	ra,4e4a <printf>
    exit(1);
    35b8:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    35ce:	48e50513          	addi	a0,a0,1166 # 6a58 <malloc+0x1b54>
    35d2:	4b6010ef          	jal	ra,4a88 <unlink>
    35d6:	c919                	beqz	a0,35ec <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    35d8:	85a6                	mv	a1,s1
    35da:	00002517          	auipc	a0,0x2
    35de:	4de50513          	addi	a0,a0,1246 # 5ab8 <malloc+0xbb4>
    35e2:	069010ef          	jal	ra,4e4a <printf>
    exit(1);
    35e6:	4505                	li	a0,1
...
00000000000035fc <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    360c:	49850513          	addi	a0,a0,1176 # 6aa0 <malloc+0x1b9c>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    362c:	47850513          	addi	a0,a0,1144 # 6aa0 <malloc+0x1b9c>
  ...
  sleep(10); // one second
    ...
    3654:	43850513          	addi	a0,a0,1080 # 5a88 <malloc+0xb84>
    3658:	7f2010ef          	jal	ra,4e4a <printf>
    exit(1);
    365c:	4505                	li	a0,1
    365e:	3da010ef          	jal	ra,4a38 <exit>
      int fd = open("stopforking", 0);
    3662:	00003497          	auipc	s1,0x3
    3666:	43e48493          	addi	s1,s1,1086 # 6aa0 <malloc+0x1b9c>
    366a:	4581                	li	a1,0
    366c:	8526                	mv	a0,s1
...
0000000000003694 <killstatus>:
{
  ...
  exit(0);
    ...
    36e6:	1e650513          	addi	a0,a0,486 # 58c8 <malloc+0x9c4>
    36ea:	760010ef          	jal	ra,4e4a <printf>
      exit(1);
    36ee:	4505                	li	a0,1
    ...
    3700:	3b450513          	addi	a0,a0,948 # 6ab0 <malloc+0x1bac>
    3704:	746010ef          	jal	ra,4e4a <printf>
       exit(1);
    3708:	4505                	li	a0,1
...
000000000000370e <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3734:	35850513          	addi	a0,a0,856 # 5a88 <malloc+0xb84>
    3738:	712010ef          	jal	ra,4e4a <printf>
    exit(1);
    373c:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3756:	17650513          	addi	a0,a0,374 # 58c8 <malloc+0x9c4>
    375a:	6f0010ef          	jal	ra,4e4a <printf>
    exit(1);
    375e:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    3786:	92658593          	addi	a1,a1,-1754 # 50a8 <malloc+0x1a4>
    ...
    37a8:	12450513          	addi	a0,a0,292 # 58c8 <malloc+0x9c4>
    37ac:	69e010ef          	jal	ra,4e4a <printf>
     exit(1);
    37b0:	4505                	li	a0,1
    ...
    37bc:	31850513          	addi	a0,a0,792 # 6ad0 <malloc+0x1bcc>
    37c0:	68a010ef          	jal	ra,4e4a <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    37ec:	30050513          	addi	a0,a0,768 # 6ae8 <malloc+0x1be4>
    37f0:	65a010ef          	jal	ra,4e4a <printf>
}
  ...
  printf("kill... ");
    ...
    3810:	2f450513          	addi	a0,a0,756 # 6b00 <malloc+0x1bfc>
    3814:	636010ef          	jal	ra,4e4a <printf>
  kill(pid1);
    3818:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    382e:	2e650513          	addi	a0,a0,742 # 6b10 <malloc+0x1c0c>
    3832:	618010ef          	jal	ra,4e4a <printf>
  wait(0);
    3836:	4501                	li	a0,0
...
000000000000384a <reparent>:
{
  ...
  exit(0);
    ...
    388e:	03e50513          	addi	a0,a0,62 # 58c8 <malloc+0x9c4>
    3892:	5b8010ef          	jal	ra,4e4a <printf>
      exit(1);
    3896:	4505                	li	a0,1
    ...
    38a2:	1b250513          	addi	a0,a0,434 # 5a50 <malloc+0xb4c>
    38a6:	5a4010ef          	jal	ra,4e4a <printf>
        exit(1);
    38aa:	4505                	li	a0,1
...
00000000000038ca <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    38fc:	0d850513          	addi	a0,a0,216 # 59d0 <malloc+0xacc>
    3900:	54a010ef          	jal	ra,4e4a <printf>
    exit(1);
    3904:	4505                	li	a0,1
    ...
    3920:	78c58593          	addi	a1,a1,1932 # 50a8 <malloc+0x1a4>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    39c0:	16450513          	addi	a0,a0,356 # 6b20 <malloc+0x1c1c>
    39c4:	486010ef          	jal	ra,4e4a <printf>
    exit(1);
    39c8:	4505                	li	a0,1
    ...
    39d4:	ef850513          	addi	a0,a0,-264 # 58c8 <malloc+0x9c4>
    39d8:	472010ef          	jal	ra,4e4a <printf>
    exit(1);
    39dc:	4505                	li	a0,1
    ...
    3a10:	13450513          	addi	a0,a0,308 # 6b40 <malloc+0x1c3c>
    3a14:	436010ef          	jal	ra,4e4a <printf>
    exit(1);
    3a18:	4505                	li	a0,1
...
0000000000003a24 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
    3a5c:	854a                	mv	a0,s2
    3a5e:	4a6010ef          	jal	ra,4f04 <malloc>
    ...
    3a68:	6084                	ld	s1,0(s1)
      free(m1);
    3a6a:	412010ef          	jal	ra,4e7c <free>
    while(m1){
    3a6e:	fce5                	bnez	s1,3a66 <mem+0x42>
    m1 = malloc(1024*20);
    3a70:	6515                	lui	a0,0x5
    3a72:	492010ef          	jal	ra,4f04 <malloc>
    if(m1 == 0){
    3a76:	c511                	beqz	a0,3a82 <mem+0x5e>
    free(m1);
    3a78:	404010ef          	jal	ra,4e7c <free>
    exit(0);
    3a7c:	4501                	li	a0,0
    ...
    3a88:	0ec50513          	addi	a0,a0,236 # 6b70 <malloc+0x1c6c>
    3a8c:	3be010ef          	jal	ra,4e4a <printf>
      exit(1);
    3a90:	4505                	li	a0,1
...
0000000000003a9c <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3ab8:	0dc50513          	addi	a0,a0,220 # 6b90 <malloc+0x1c8c>
    3abc:	7cd000ef          	jal	ra,4a88 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3ac0:	20200593          	li	a1,514
    3ac4:	00003517          	auipc	a0,0x3
    3ac8:	0cc50513          	addi	a0,a0,204 # 6b90 <malloc+0x1c8c>
  ...
  if(pid == 0) {
    ...
    3b1a:	08a50513          	addi	a0,a0,138 # 6ba0 <malloc+0x1c9c>
    3b1e:	32c010ef          	jal	ra,4e4a <printf>
    exit(1);
    3b22:	4505                	li	a0,1
    ...
    3b2e:	09e50513          	addi	a0,a0,158 # 6bc8 <malloc+0x1cc4>
    3b32:	318010ef          	jal	ra,4e4a <printf>
      exit(1);
    3b36:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3b5e:	03650513          	addi	a0,a0,54 # 6b90 <malloc+0x1c8c>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3b96:	05650513          	addi	a0,a0,86 # 6be8 <malloc+0x1ce4>
    3b9a:	2b0010ef          	jal	ra,4e4a <printf>
    exit(1);
    3b9e:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3bc6:	fce50513          	addi	a0,a0,-50 # 6b90 <malloc+0x1c8c>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3be8:	02c50513          	addi	a0,a0,44 # 6c10 <malloc+0x1d0c>
    3bec:	25e010ef          	jal	ra,4e4a <printf>
    exit(1);
    3bf0:	4505                	li	a0,1
...
0000000000003bfc <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c22:	3c278793          	addi	a5,a5,962 # 4fe0 <malloc+0xdc>
    3c26:	f6f43823          	sd	a5,-144(s0)
    3c2a:	00001797          	auipc	a5,0x1
    3c2e:	3be78793          	addi	a5,a5,958 # 4fe8 <malloc+0xe4>
    3c32:	f6f43c23          	sd	a5,-136(s0)
    3c36:	00001797          	auipc	a5,0x1
    3c3a:	3ba78793          	addi	a5,a5,954 # 4ff0 <malloc+0xec>
    3c3e:	f8f43023          	sd	a5,-128(s0)
    3c42:	00001797          	auipc	a5,0x1
    3c46:	3b678793          	addi	a5,a5,950 # 4ff8 <malloc+0xf4>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3cb2:	c1a50513          	addi	a0,a0,-998 # 58c8 <malloc+0x9c4>
    3cb6:	194010ef          	jal	ra,4e4a <printf>
      exit(1);
    3cba:	4505                	li	a0,1
    ...
    3d16:	c4e50513          	addi	a0,a0,-946 # 5960 <malloc+0xa5c>
    3d1a:	130010ef          	jal	ra,4e4a <printf>
        exit(1);
    3d1e:	4505                	li	a0,1
    3d20:	519000ef          	jal	ra,4a38 <exit>
          printf("write failed %d\n", n);
    3d24:	00003517          	auipc	a0,0x3
    3d28:	f0450513          	addi	a0,a0,-252 # 6c28 <malloc+0x1d24>
    3d2c:	11e010ef          	jal	ra,4e4a <printf>
          exit(1);
    3d30:	4505                	li	a0,1
    ...
    3d44:	f0050513          	addi	a0,a0,-256 # 6c40 <malloc+0x1d3c>
    3d48:	102010ef          	jal	ra,4e4a <printf>
          exit(1);
    3d4c:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3dba:	e9a50513          	addi	a0,a0,-358 # 6c50 <malloc+0x1d4c>
    3dbe:	08c010ef          	jal	ra,4e4a <printf>
      exit(1);
    3dc2:	4505                	li	a0,1
...
0000000000003de6 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e14:	e58b8b93          	addi	s7,s7,-424 # 6c68 <malloc+0x1d64>
  for(i = 0; i < N; i++){
    ...
    3e4e:	e2650513          	addi	a0,a0,-474 # 6c70 <malloc+0x1d6c>
    3e52:	7f9000ef          	jal	ra,4e4a <printf>
        exit(1);
    3e56:	4505                	li	a0,1
    ...
    3e64:	e0850513          	addi	a0,a0,-504 # 6c68 <malloc+0x1d64>
  ...
  fd = open(".", 0);
    ...
    3e8c:	89850513          	addi	a0,a0,-1896 # 5720 <malloc+0x81c>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3efa:	d9a50513          	addi	a0,a0,-614 # 6c90 <malloc+0x1d8c>
    3efe:	74d000ef          	jal	ra,4e4a <printf>
        exit(1);
    3f02:	4505                	li	a0,1
    ...
    3f12:	da250513          	addi	a0,a0,-606 # 6cb0 <malloc+0x1dac>
    3f16:	735000ef          	jal	ra,4e4a <printf>
        exit(1);
    3f1a:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    3f3e:	d9e50513          	addi	a0,a0,-610 # 6cd8 <malloc+0x1dd4>
    3f42:	709000ef          	jal	ra,4e4a <printf>
    exit(1);
    3f46:	4505                	li	a0,1
    ...
    3f52:	97a50513          	addi	a0,a0,-1670 # 58c8 <malloc+0x9c4>
    3f56:	6f5000ef          	jal	ra,4e4a <printf>
      exit(1);
    3f5a:	4505                	li	a0,1
...
0000000000004088 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40a0:	c7450513          	addi	a0,a0,-908 # 6d10 <malloc+0x1e0c>
    40a4:	1e5000ef          	jal	ra,4a88 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    40a8:	20200593          	li	a1,514
    40ac:	00003517          	auipc	a0,0x3
    40b0:	c6450513          	addi	a0,a0,-924 # 6d10 <malloc+0x1e0c>
  ...
  fd = open("bigfile.dat", 0);
    ...
    40fc:	c1850513          	addi	a0,a0,-1000 # 6d10 <malloc+0x1e0c>
  ...
  for(i = 0; ; i++){
    ...
    4158:	bcc50513          	addi	a0,a0,-1076 # 6d20 <malloc+0x1e1c>
    415c:	4ef000ef          	jal	ra,4e4a <printf>
    exit(1);
    4160:	4505                	li	a0,1
    ...
    416c:	bd850513          	addi	a0,a0,-1064 # 6d40 <malloc+0x1e3c>
    4170:	4db000ef          	jal	ra,4e4a <printf>
      exit(1);
    4174:	4505                	li	a0,1
    ...
    4180:	be450513          	addi	a0,a0,-1052 # 6d60 <malloc+0x1e5c>
    4184:	4c7000ef          	jal	ra,4e4a <printf>
    exit(1);
    4188:	4505                	li	a0,1
    ...
    4194:	bf050513          	addi	a0,a0,-1040 # 6d80 <malloc+0x1e7c>
    4198:	4b3000ef          	jal	ra,4e4a <printf>
      exit(1);
    419c:	4505                	li	a0,1
    ...
    41a8:	bfc50513          	addi	a0,a0,-1028 # 6da0 <malloc+0x1e9c>
    41ac:	49f000ef          	jal	ra,4e4a <printf>
      exit(1);
    41b0:	4505                	li	a0,1
    ...
    41bc:	c0050513          	addi	a0,a0,-1024 # 6db8 <malloc+0x1eb4>
    41c0:	48b000ef          	jal	ra,4e4a <printf>
      exit(1);
    41c4:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    41de:	b3650513          	addi	a0,a0,-1226 # 6d10 <malloc+0x1e0c>
    ...
    41fe:	bde50513          	addi	a0,a0,-1058 # 6dd8 <malloc+0x1ed4>
    4202:	449000ef          	jal	ra,4e4a <printf>
    exit(1);
    4206:	4505                	li	a0,1
...
000000000000420c <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    421c:	be050513          	addi	a0,a0,-1056 # 6df8 <malloc+0x1ef4>
  ...
  fd = open("bigarg-ok", 0);
    ...
    4242:	bba50513          	addi	a0,a0,-1094 # 6df8 <malloc+0x1ef4>
  ...
  close(fd);
    ...
    429c:	da050513          	addi	a0,a0,-608 # 5038 <malloc+0x134>
    42a0:	7d0000ef          	jal	ra,4a70 <exec>
    fd = open("bigarg-ok", O_CREATE);
    42a4:	20000593          	li	a1,512
    42a8:	00003517          	auipc	a0,0x3
    42ac:	b5050513          	addi	a0,a0,-1200 # 6df8 <malloc+0x1ef4>
    ...
    42c4:	b4850513          	addi	a0,a0,-1208 # 6e08 <malloc+0x1f04>
    42c8:	383000ef          	jal	ra,4e4a <printf>
    exit(1);
    42cc:	4505                	li	a0,1
    ...
    42dc:	b5050513          	addi	a0,a0,-1200 # 6e28 <malloc+0x1f24>
    42e0:	36b000ef          	jal	ra,4e4a <printf>
    exit(1);
    42e4:	4505                	li	a0,1
...
00000000000042ea <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    430c:	b4050513          	addi	a0,a0,-1216 # 6e48 <malloc+0x1f44>
    4310:	33b000ef          	jal	ra,4e4a <printf>
  for(nfiles = 0; ; nfiles++){
    4314:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4328:	b34c8c93          	addi	s9,s9,-1228 # 6e58 <malloc+0x1f54>
    int total = 0;
    432c:	4d81                	li	s11,0
    ...
    437a:	8566                	mv	a0,s9
    437c:	2cf000ef          	jal	ra,4e4a <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    439a:	ad250513          	addi	a0,a0,-1326 # 6e68 <malloc+0x1f64>
    439e:	2ad000ef          	jal	ra,4e4a <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4408:	a8450513          	addi	a0,a0,-1404 # 6e88 <malloc+0x1f84>
    440c:	23f000ef          	jal	ra,4e4a <printf>
}
    ...
    4450:	a2c50513          	addi	a0,a0,-1492 # 6e78 <malloc+0x1f74>
    4454:	1f7000ef          	jal	ra,4e4a <printf>
    close(fd);
    4458:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    447a:	a2a50513          	addi	a0,a0,-1494 # 6ea0 <malloc+0x1f9c>
    447e:	1cd000ef          	jal	ra,4e4a <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    449e:	a2e50513          	addi	a0,a0,-1490 # 6ec8 <malloc+0x1fc4>
    44a2:	1a9000ef          	jal	ra,4e4a <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    44be:	9f650513          	addi	a0,a0,-1546 # 6eb0 <malloc+0x1fac>
    44c2:	189000ef          	jal	ra,4e4a <printf>
    exit(1);
    44c6:	4505                	li	a0,1
    ...
    44da:	9fa50513          	addi	a0,a0,-1542 # 6ed0 <malloc+0x1fcc>
    44de:	16d000ef          	jal	ra,4e4a <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    4532:	9aa50513          	addi	a0,a0,-1622 # 6ed8 <malloc+0x1fd4>
    4536:	115000ef          	jal	ra,4e4a <printf>
          return 1;
    453a:	4505                	li	a0,1
...
countfree()
{
  ...
  if(pid == 0){
    ...
    458a:	b2298993          	addi	s3,s3,-1246 # 50a8 <malloc+0x1a4>
      uint64 a = (uint64) sbrk(4096);
    ...
    45b4:	98050513          	addi	a0,a0,-1664 # 6f30 <malloc+0x202c>
    45b8:	093000ef          	jal	ra,4e4a <printf>
        exit(1);
    45bc:	4505                	li	a0,1
    45be:	47a000ef          	jal	ra,4a38 <exit>
    printf("pipe() failed in countfree()\n");
    45c2:	00003517          	auipc	a0,0x3
    45c6:	92e50513          	addi	a0,a0,-1746 # 6ef0 <malloc+0x1fec>
    45ca:	081000ef          	jal	ra,4e4a <printf>
    exit(1);
    45ce:	4505                	li	a0,1
    45d0:	468000ef          	jal	ra,4a38 <exit>
    printf("fork failed in countfree()\n");
    45d4:	00003517          	auipc	a0,0x3
    45d8:	93c50513          	addi	a0,a0,-1732 # 6f10 <malloc+0x200c>
    45dc:	06f000ef          	jal	ra,4e4a <printf>
    exit(1);
    45e0:	4505                	li	a0,1
  ...
  while(1){
    ...
    4612:	94250513          	addi	a0,a0,-1726 # 6f50 <malloc+0x204c>
    4616:	035000ef          	jal	ra,4e4a <printf>
      exit(1);
    461a:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    4664:	910b8b93          	addi	s7,s7,-1776 # 6f70 <malloc+0x206c>
    int free0 = countfree();
    int free1 = 0;
    ...
    printf("usertests starting\n");
    46a0:	855e                	mv	a0,s7
    46a2:	7a8000ef          	jal	ra,4e4a <printf>
    int free0 = countfree();
    ...
    46de:	85aa                	mv	a1,a0
    46e0:	8566                	mv	a0,s9
    46e2:	768000ef          	jal	ra,4e4a <printf>
      if(continuous != 2) {
    ...
    46ea:	85aa                	mv	a1,a0
    46ec:	8566                	mv	a0,s9
    46ee:	75c000ef          	jal	ra,4e4a <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  int continuous = 0;
    ...
    479a:	85a50513          	addi	a0,a0,-1958 # 6ff0 <malloc+0x20ec>
    479e:	6ac000ef          	jal	ra,4e4a <printf>
    exit(1);
    47a2:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    47be:	86650513          	addi	a0,a0,-1946 # 7020 <malloc+0x211c>
    47c2:	688000ef          	jal	ra,4e4a <printf>
  exit(0);
    47c6:	4501                	li	a0,0
...
putc(int fd, char c)
{
    4ae0:	1101                	addi	sp,sp,-32
    4ae2:	ec06                	sd	ra,24(sp)
    4ae4:	e822                	sd	s0,16(sp)
    4ae6:	1000                	addi	s0,sp,32
    4ae8:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4aec:	4605                	li	a2,1
    4aee:	fef40593          	addi	a1,s0,-17
    4af2:	f67ff0ef          	jal	ra,4a58 <write>
}
    4af6:	60e2                	ld	ra,24(sp)
    4af8:	6442                	ld	s0,16(sp)
    4afa:	6105                	addi	sp,sp,32
    4afc:	8082                	ret

0000000000004afe <printint>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
    4b0e:	c299                	beqz	a3,4b14 <printint+0x16>
    4b10:	0805c663          	bltz	a1,4b9c <printint+0x9e>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    4b14:	2581                	sext.w	a1,a1
  neg = 0;
    4b16:	4881                	li	a7,0
    4b18:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    4b1e:	2601                	sext.w	a2,a2
    4b20:	00003517          	auipc	a0,0x3
    4b24:	8d050513          	addi	a0,a0,-1840 # 73f0 <digits>
    4b28:	883a                	mv	a6,a4
    4b2a:	2705                	addiw	a4,a4,1
    4b2c:	02c5f7bb          	remuw	a5,a1,a2
    4b30:	1782                	slli	a5,a5,0x20
    4b32:	9381                	srli	a5,a5,0x20
    4b34:	97aa                	add	a5,a5,a0
    4b36:	0007c783          	lbu	a5,0(a5)
    4b3a:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    4b3e:	0005879b          	sext.w	a5,a1
    4b42:	02c5d5bb          	divuw	a1,a1,a2
    4b46:	0685                	addi	a3,a3,1
    4b48:	fec7f0e3          	bgeu	a5,a2,4b28 <printint+0x2a>
  if(neg)
    4b4c:	00088b63          	beqz	a7,4b62 <printint+0x64>
    buf[i++] = '-';
    4b50:	fd040793          	addi	a5,s0,-48
    4b54:	973e                	add	a4,a4,a5
    4b56:	02d00793          	li	a5,45
    4b5a:	fef70823          	sb	a5,-16(a4)
    4b5e:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    4b62:	02e05663          	blez	a4,4b8e <printint+0x90>
    4b66:	fc040793          	addi	a5,s0,-64
    4b6a:	00e78933          	add	s2,a5,a4
    4b6e:	fff78993          	addi	s3,a5,-1
    4b72:	99ba                	add	s3,s3,a4
    4b74:	377d                	addiw	a4,a4,-1
    4b76:	1702                	slli	a4,a4,0x20
    4b78:	9301                	srli	a4,a4,0x20
    4b7a:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    4b7e:	fff94583          	lbu	a1,-1(s2)
    4b82:	8526                	mv	a0,s1
    4b84:	f5dff0ef          	jal	ra,4ae0 <putc>
  while(--i >= 0)
    4b88:	197d                	addi	s2,s2,-1
    4b8a:	ff391ae3          	bne	s2,s3,4b7e <printint+0x80>
}
    ...
    4b98:	6121                	addi	sp,sp,64
    4b9a:	8082                	ret
    x = -xx;
    4b9c:	40b005bb          	negw	a1,a1
    neg = 1;
    4ba0:	4885                	li	a7,1
    x = -xx;
    4ba2:	bf9d                	j	4b18 <printint+0x1a>

0000000000004ba4 <vprintf>:
}
...
{
    4ba4:	7119                	addi	sp,sp,-128
    4ba6:	fc86                	sd	ra,120(sp)
    4ba8:	f8a2                	sd	s0,112(sp)
    4baa:	f4a6                	sd	s1,104(sp)
    4bac:	f0ca                	sd	s2,96(sp)
    4bae:	ecce                	sd	s3,88(sp)
    4bb0:	e8d2                	sd	s4,80(sp)
    4bb2:	e4d6                	sd	s5,72(sp)
    4bb4:	e0da                	sd	s6,64(sp)
    4bb6:	fc5e                	sd	s7,56(sp)
    4bb8:	f862                	sd	s8,48(sp)
    4bba:	f466                	sd	s9,40(sp)
    4bbc:	f06a                	sd	s10,32(sp)
    4bbe:	ec6e                	sd	s11,24(sp)
    4bc0:	0100                	addi	s0,sp,128
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4bc2:	0005c903          	lbu	s2,0(a1)
    4bc6:	22090e63          	beqz	s2,4e02 <vprintf+0x25e>
    4bca:	8b2a                	mv	s6,a0
    4bcc:	8a2e                	mv	s4,a1
    4bce:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4bd6:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4bda:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4bde:	06c00d13          	li	s10,108
    ...
    4be2:	07500d93          	li	s11,117
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    4be6:	00003c97          	auipc	s9,0x3
    4bea:	80ac8c93          	addi	s9,s9,-2038 # 73f0 <digits>
    4bee:	a005                	j	4c0e <vprintf+0x6a>
        putc(fd, c0);
    4bf0:	85ca                	mv	a1,s2
    4bf2:	855a                	mv	a0,s6
    4bf4:	eedff0ef          	jal	ra,4ae0 <putc>
    4bf8:	a019                	j	4bfe <vprintf+0x5a>
    } else if(state == '%'){
    4bfa:	03598263          	beq	s3,s5,4c1e <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    4bfe:	2485                	addiw	s1,s1,1
    4c00:	8726                	mv	a4,s1
    4c02:	009a07b3          	add	a5,s4,s1
    4c06:	0007c903          	lbu	s2,0(a5)
    4c0a:	1e090c63          	beqz	s2,4e02 <vprintf+0x25e>
    c0 = fmt[i] & 0xff;
    4c0e:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4c12:	fe0994e3          	bnez	s3,4bfa <vprintf+0x56>
      if(c0 == '%'){
    4c16:	fd579de3          	bne	a5,s5,4bf0 <vprintf+0x4c>
        state = '%';
    4c1a:	89be                	mv	s3,a5
    4c1c:	b7cd                	j	4bfe <vprintf+0x5a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4c1e:	cfa5                	beqz	a5,4c96 <vprintf+0xf2>
    4c20:	00ea06b3          	add	a3,s4,a4
    4c24:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4c28:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4c2a:	c681                	beqz	a3,4c32 <vprintf+0x8e>
    4c2c:	9752                	add	a4,a4,s4
    4c2e:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4c32:	03878a63          	beq	a5,s8,4c66 <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
    4c36:	05a78463          	beq	a5,s10,4c7e <vprintf+0xda>
      } else if(c0 == 'u'){
    4c3a:	0db78763          	beq	a5,s11,4d08 <vprintf+0x164>
    ...
    4c3e:	07800713          	li	a4,120
    4c42:	10e78963          	beq	a5,a4,4d54 <vprintf+0x1b0>
    ...
    4c46:	07000713          	li	a4,112
    4c4a:	12e78e63          	beq	a5,a4,4d86 <vprintf+0x1e2>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
    4c4e:	07300713          	li	a4,115
    4c52:	16e78b63          	beq	a5,a4,4dc8 <vprintf+0x224>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4c56:	05579063          	bne	a5,s5,4c96 <vprintf+0xf2>
        putc(fd, '%');
    4c5a:	85d6                	mv	a1,s5
    4c5c:	855a                	mv	a0,s6
    4c5e:	e83ff0ef          	jal	ra,4ae0 <putc>
      ...
      state = 0;
    4c62:	4981                	li	s3,0
    4c64:	bf69                	j	4bfe <vprintf+0x5a>
        printint(fd, va_arg(ap, int), 10, 1);
    4c66:	008b8913          	addi	s2,s7,8
    4c6a:	4685                	li	a3,1
    4c6c:	4629                	li	a2,10
    4c6e:	000ba583          	lw	a1,0(s7)
    4c72:	855a                	mv	a0,s6
    4c74:	e8bff0ef          	jal	ra,4afe <printint>
    4c78:	8bca                	mv	s7,s2
      state = 0;
    4c7a:	4981                	li	s3,0
    4c7c:	b749                	j	4bfe <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'd'){
    4c7e:	03868663          	beq	a3,s8,4caa <vprintf+0x106>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4c82:	05a68163          	beq	a3,s10,4cc4 <vprintf+0x120>
      } else if(c0 == 'l' && c1 == 'u'){
    4c86:	09b68d63          	beq	a3,s11,4d20 <vprintf+0x17c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    4c8a:	03a68f63          	beq	a3,s10,4cc8 <vprintf+0x124>
      } else if(c0 == 'l' && c1 == 'x'){
    4c8e:	07800793          	li	a5,120
    4c92:	0cf68d63          	beq	a3,a5,4d6c <vprintf+0x1c8>
        putc(fd, '%');
    4c96:	85d6                	mv	a1,s5
    4c98:	855a                	mv	a0,s6
    4c9a:	e47ff0ef          	jal	ra,4ae0 <putc>
        putc(fd, c0);
    4c9e:	85ca                	mv	a1,s2
    4ca0:	855a                	mv	a0,s6
    4ca2:	e3fff0ef          	jal	ra,4ae0 <putc>
      state = 0;
    4ca6:	4981                	li	s3,0
    4ca8:	bf99                	j	4bfe <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4caa:	008b8913          	addi	s2,s7,8
    4cae:	4685                	li	a3,1
    4cb0:	4629                	li	a2,10
    4cb2:	000ba583          	lw	a1,0(s7)
    4cb6:	855a                	mv	a0,s6
    4cb8:	e47ff0ef          	jal	ra,4afe <printint>
        i += 1;
    4cbc:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    4cbe:	8bca                	mv	s7,s2
      state = 0;
    4cc0:	4981                	li	s3,0
        i += 1;
    4cc2:	bf35                	j	4bfe <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4cc4:	03860563          	beq	a2,s8,4cee <vprintf+0x14a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    4cc8:	07b60963          	beq	a2,s11,4d3a <vprintf+0x196>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    4ccc:	07800793          	li	a5,120
    4cd0:	fcf613e3          	bne	a2,a5,4c96 <vprintf+0xf2>
        printint(fd, va_arg(ap, uint64), 16, 0);
    4cd4:	008b8913          	addi	s2,s7,8
    4cd8:	4681                	li	a3,0
    4cda:	4641                	li	a2,16
    4cdc:	000ba583          	lw	a1,0(s7)
    4ce0:	855a                	mv	a0,s6
    4ce2:	e1dff0ef          	jal	ra,4afe <printint>
        i += 2;
    4ce6:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    4ce8:	8bca                	mv	s7,s2
      state = 0;
    4cea:	4981                	li	s3,0
        i += 2;
    4cec:	bf09                	j	4bfe <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    4cfa:	855a                	mv	a0,s6
    4cfc:	e03ff0ef          	jal	ra,4afe <printint>
        i += 2;
    ...
    4d04:	4981                	li	s3,0
        i += 2;
    4d06:	bde5                	j	4bfe <vprintf+0x5a>
        printint(fd, va_arg(ap, int), 10, 0);
    4d08:	008b8913          	addi	s2,s7,8
    4d0c:	4681                	li	a3,0
    4d0e:	4629                	li	a2,10
    4d10:	000ba583          	lw	a1,0(s7)
    4d14:	855a                	mv	a0,s6
    4d16:	de9ff0ef          	jal	ra,4afe <printint>
    4d1a:	8bca                	mv	s7,s2
      state = 0;
    4d1c:	4981                	li	s3,0
    4d1e:	b5c5                	j	4bfe <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    4d2c:	855a                	mv	a0,s6
    4d2e:	dd1ff0ef          	jal	ra,4afe <printint>
        i += 1;
    4d32:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 0);
    4d34:	8bca                	mv	s7,s2
      state = 0;
    4d36:	4981                	li	s3,0
        i += 1;
    4d38:	b5d9                	j	4bfe <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    4d46:	855a                	mv	a0,s6
    4d48:	db7ff0ef          	jal	ra,4afe <printint>
        i += 2;
    ...
    4d60:	855a                	mv	a0,s6
    4d62:	d9dff0ef          	jal	ra,4afe <printint>
    4d66:	8bca                	mv	s7,s2
      state = 0;
    4d68:	4981                	li	s3,0
    4d6a:	bd51                	j	4bfe <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    ...
    4d78:	855a                	mv	a0,s6
    4d7a:	d85ff0ef          	jal	ra,4afe <printint>
        i += 1;
    ...
    4d82:	4981                	li	s3,0
        i += 1;
    4d84:	bdad                	j	4bfe <vprintf+0x5a>
        printptr(fd, va_arg(ap, uint64));
    4d86:	008b8793          	addi	a5,s7,8
    4d8a:	f8f43423          	sd	a5,-120(s0)
    4d8e:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    4d92:	03000593          	li	a1,48
    4d96:	855a                	mv	a0,s6
    4d98:	d49ff0ef          	jal	ra,4ae0 <putc>
  putc(fd, 'x');
    4d9c:	07800593          	li	a1,120
    4da0:	855a                	mv	a0,s6
    4da2:	d3fff0ef          	jal	ra,4ae0 <putc>
    4da6:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    4da8:	03c9d793          	srli	a5,s3,0x3c
    4dac:	97e6                	add	a5,a5,s9
    4dae:	0007c583          	lbu	a1,0(a5)
    4db2:	855a                	mv	a0,s6
    4db4:	d2dff0ef          	jal	ra,4ae0 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    4db8:	0992                	slli	s3,s3,0x4
    4dba:	397d                	addiw	s2,s2,-1
    4dbc:	fe0916e3          	bnez	s2,4da8 <vprintf+0x204>
        printptr(fd, va_arg(ap, uint64));
    4dc0:	f8843b83          	ld	s7,-120(s0)
      state = 0;
    4dc4:	4981                	li	s3,0
    4dc6:	bd25                	j	4bfe <vprintf+0x5a>
        if((s = va_arg(ap, char*)) == 0)
    4dc8:	008b8993          	addi	s3,s7,8
    4dcc:	000bb903          	ld	s2,0(s7)
    4dd0:	00090f63          	beqz	s2,4dee <vprintf+0x24a>
        for(; *s; s++)
    4dd4:	00094583          	lbu	a1,0(s2)
    4dd8:	c195                	beqz	a1,4dfc <vprintf+0x258>
          putc(fd, *s);
    4dda:	855a                	mv	a0,s6
    4ddc:	d05ff0ef          	jal	ra,4ae0 <putc>
        for(; *s; s++)
    4de0:	0905                	addi	s2,s2,1
    4de2:	00094583          	lbu	a1,0(s2)
    4de6:	f9f5                	bnez	a1,4dda <vprintf+0x236>
        if((s = va_arg(ap, char*)) == 0)
    4de8:	8bce                	mv	s7,s3
      state = 0;
    4dea:	4981                	li	s3,0
    4dec:	bd09                	j	4bfe <vprintf+0x5a>
          s = "(null)";
    4dee:	00002917          	auipc	s2,0x2
    4df2:	5fa90913          	addi	s2,s2,1530 # 73e8 <malloc+0x24e4>
        for(; *s; s++)
    4df6:	02800593          	li	a1,40
    4dfa:	b7c5                	j	4dda <vprintf+0x236>
        if((s = va_arg(ap, char*)) == 0)
    4dfc:	8bce                	mv	s7,s3
      state = 0;
    4dfe:	4981                	li	s3,0
    4e00:	bbfd                	j	4bfe <vprintf+0x5a>
    }
  }
}
    4e02:	70e6                	ld	ra,120(sp)
    4e04:	7446                	ld	s0,112(sp)
    4e06:	74a6                	ld	s1,104(sp)
    4e08:	7906                	ld	s2,96(sp)
    4e0a:	69e6                	ld	s3,88(sp)
    4e0c:	6a46                	ld	s4,80(sp)
    4e0e:	6aa6                	ld	s5,72(sp)
    4e10:	6b06                	ld	s6,64(sp)
    4e12:	7be2                	ld	s7,56(sp)
    4e14:	7c42                	ld	s8,48(sp)
    4e16:	7ca2                	ld	s9,40(sp)
    4e18:	7d02                	ld	s10,32(sp)
    4e1a:	6de2                	ld	s11,24(sp)
    4e1c:	6109                	addi	sp,sp,128
    4e1e:	8082                	ret

0000000000004e20 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    4e20:	715d                	addi	sp,sp,-80
    4e22:	ec06                	sd	ra,24(sp)
    4e24:	e822                	sd	s0,16(sp)
    4e26:	1000                	addi	s0,sp,32
    4e28:	e010                	sd	a2,0(s0)
    4e2a:	e414                	sd	a3,8(s0)
    4e2c:	e818                	sd	a4,16(s0)
    4e2e:	ec1c                	sd	a5,24(s0)
    4e30:	03043023          	sd	a6,32(s0)
    4e34:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    4e38:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    4e3c:	8622                	mv	a2,s0
    4e3e:	d67ff0ef          	jal	ra,4ba4 <vprintf>
}
    4e42:	60e2                	ld	ra,24(sp)
    4e44:	6442                	ld	s0,16(sp)
    4e46:	6161                	addi	sp,sp,80
    4e48:	8082                	ret

0000000000004e4a <printf>:

void
printf(const char *fmt, ...)
{
    4e4a:	711d                	addi	sp,sp,-96
    4e4c:	ec06                	sd	ra,24(sp)
    4e4e:	e822                	sd	s0,16(sp)
    4e50:	1000                	addi	s0,sp,32
    4e52:	e40c                	sd	a1,8(s0)
    4e54:	e810                	sd	a2,16(s0)
    4e56:	ec14                	sd	a3,24(s0)
    4e58:	f018                	sd	a4,32(s0)
    4e5a:	f41c                	sd	a5,40(s0)
    4e5c:	03043823          	sd	a6,48(s0)
    4e60:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    4e64:	00840613          	addi	a2,s0,8
    4e68:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    4e6c:	85aa                	mv	a1,a0
    4e6e:	4505                	li	a0,1
    4e70:	d35ff0ef          	jal	ra,4ba4 <vprintf>
}
    4e74:	60e2                	ld	ra,24(sp)
    4e76:	6442                	ld	s0,16(sp)
    4e78:	6125                	addi	sp,sp,96
    4e7a:	8082                	ret

0000000000004e7c <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    4e82:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4e86:	00003797          	auipc	a5,0x3
    4e8a:	5ca7b783          	ld	a5,1482(a5) # 8450 <freep>
    4e8e:	a805                	j	4ebe <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    4e90:	4618                	lw	a4,8(a2)
    4e92:	9db9                	addw	a1,a1,a4
    4e94:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    4e98:	6398                	ld	a4,0(a5)
    4e9a:	6318                	ld	a4,0(a4)
    4e9c:	fee53823          	sd	a4,-16(a0)
    4ea0:	a091                	j	4ee4 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    4ea2:	ff852703          	lw	a4,-8(a0)
    4ea6:	9e39                	addw	a2,a2,a4
    4ea8:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    4eaa:	ff053703          	ld	a4,-16(a0)
    4eae:	e398                	sd	a4,0(a5)
    4eb0:	a099                	j	4ef6 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4eb2:	6398                	ld	a4,0(a5)
    4eb4:	00e7e463          	bltu	a5,a4,4ebc <free+0x40>
    4eb8:	00e6ea63          	bltu	a3,a4,4ecc <free+0x50>
{
    4ebc:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4ebe:	fed7fae3          	bgeu	a5,a3,4eb2 <free+0x36>
    4ec2:	6398                	ld	a4,0(a5)
    4ec4:	00e6e463          	bltu	a3,a4,4ecc <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4ec8:	fee7eae3          	bltu	a5,a4,4ebc <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    4ecc:	ff852583          	lw	a1,-8(a0)
    4ed0:	6390                	ld	a2,0(a5)
    4ed2:	02059713          	slli	a4,a1,0x20
    4ed6:	9301                	srli	a4,a4,0x20
    4ed8:	0712                	slli	a4,a4,0x4
    4eda:	9736                	add	a4,a4,a3
    4edc:	fae60ae3          	beq	a2,a4,4e90 <free+0x14>
    bp->s.ptr = p->s.ptr;
    4ee0:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    4ee4:	4790                	lw	a2,8(a5)
    4ee6:	02061713          	slli	a4,a2,0x20
    4eea:	9301                	srli	a4,a4,0x20
    4eec:	0712                	slli	a4,a4,0x4
    4eee:	973e                	add	a4,a4,a5
    4ef0:	fae689e3          	beq	a3,a4,4ea2 <free+0x26>
  } else
    p->s.ptr = bp;
    4ef4:	e394                	sd	a3,0(a5)
  freep = p;
    4ef6:	00003717          	auipc	a4,0x3
    4efa:	54f73d23          	sd	a5,1370(a4) # 8450 <freep>
}
    4efe:	6422                	ld	s0,8(sp)
    4f00:	0141                	addi	sp,sp,16
    4f02:	8082                	ret

0000000000004f04 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    4f04:	7139                	addi	sp,sp,-64
    4f06:	fc06                	sd	ra,56(sp)
    4f08:	f822                	sd	s0,48(sp)
    4f0a:	f426                	sd	s1,40(sp)
    4f0c:	f04a                	sd	s2,32(sp)
    4f0e:	ec4e                	sd	s3,24(sp)
    4f10:	e852                	sd	s4,16(sp)
    4f12:	e456                	sd	s5,8(sp)
    4f14:	e05a                	sd	s6,0(sp)
    4f16:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4f18:	02051493          	slli	s1,a0,0x20
    4f1c:	9081                	srli	s1,s1,0x20
    4f1e:	04bd                	addi	s1,s1,15
    4f20:	8091                	srli	s1,s1,0x4
    4f22:	0014899b          	addiw	s3,s1,1
    4f26:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    4f28:	00003517          	auipc	a0,0x3
    4f2c:	52853503          	ld	a0,1320(a0) # 8450 <freep>
    4f30:	c515                	beqz	a0,4f5c <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4f32:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    4f34:	4798                	lw	a4,8(a5)
    4f36:	02977f63          	bgeu	a4,s1,4f74 <malloc+0x70>
    4f3a:	8a4e                	mv	s4,s3
    4f3c:	0009871b          	sext.w	a4,s3
    4f40:	6685                	lui	a3,0x1
    4f42:	00d77363          	bgeu	a4,a3,4f48 <malloc+0x44>
    4f46:	6a05                	lui	s4,0x1
    4f48:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    4f4c:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    4f50:	00003917          	auipc	s2,0x3
    4f54:	50090913          	addi	s2,s2,1280 # 8450 <freep>
  if(p == (char*)-1)
    4f58:	5afd                	li	s5,-1
    4f5a:	a0bd                	j	4fc8 <malloc+0xc4>
    base.s.ptr = freep = prevp = &base;
    4f5c:	0000a797          	auipc	a5,0xa
    4f60:	d1c78793          	addi	a5,a5,-740 # ec78 <base>
    4f64:	00003717          	auipc	a4,0x3
    4f68:	4ef73623          	sd	a5,1260(a4) # 8450 <freep>
    4f6c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    4f6e:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    4f72:	b7e1                	j	4f3a <malloc+0x36>
      if(p->s.size == nunits)
    4f74:	02e48b63          	beq	s1,a4,4faa <malloc+0xa6>
        p->s.size -= nunits;
    4f78:	4137073b          	subw	a4,a4,s3
    4f7c:	c798                	sw	a4,8(a5)
        p += p->s.size;
    4f7e:	1702                	slli	a4,a4,0x20
    4f80:	9301                	srli	a4,a4,0x20
    4f82:	0712                	slli	a4,a4,0x4
    4f84:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    4f86:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    4f8a:	00003717          	auipc	a4,0x3
    4f8e:	4ca73323          	sd	a0,1222(a4) # 8450 <freep>
      return (void*)(p + 1);
    4f92:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    4f96:	70e2                	ld	ra,56(sp)
    4f98:	7442                	ld	s0,48(sp)
    4f9a:	74a2                	ld	s1,40(sp)
    4f9c:	7902                	ld	s2,32(sp)
    4f9e:	69e2                	ld	s3,24(sp)
    4fa0:	6a42                	ld	s4,16(sp)
    4fa2:	6aa2                	ld	s5,8(sp)
    4fa4:	6b02                	ld	s6,0(sp)
    4fa6:	6121                	addi	sp,sp,64
    4fa8:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    4faa:	6398                	ld	a4,0(a5)
    4fac:	e118                	sd	a4,0(a0)
    4fae:	bff1                	j	4f8a <malloc+0x86>
  hp->s.size = nu;
    4fb0:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    4fb4:	0541                	addi	a0,a0,16
    4fb6:	ec7ff0ef          	jal	ra,4e7c <free>
  return freep;
    4fba:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    4fbe:	dd61                	beqz	a0,4f96 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4fc0:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    4fc2:	4798                	lw	a4,8(a5)
    4fc4:	fa9778e3          	bgeu	a4,s1,4f74 <malloc+0x70>
    if(p == freep)
    4fc8:	00093703          	ld	a4,0(s2)
    4fcc:	853e                	mv	a0,a5
    4fce:	fef719e3          	bne	a4,a5,4fc0 <malloc+0xbc>
  p = sbrk(nu * sizeof(Header));
    4fd2:	8552                	mv	a0,s4
    4fd4:	aedff0ef          	jal	ra,4ac0 <sbrk>
  if(p == (char*)-1)
    4fd8:	fd551ce3          	bne	a0,s5,4fb0 <malloc+0xac>
        return 0;
    4fdc:	4501                	li	a0,0
    4fde:	bf65                	j	4f96 <malloc+0x92>
